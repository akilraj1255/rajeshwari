...
class SiteController extends RController
{
	...
	public function actionSearch()
	{
		...
		$criteria_1->condition='(first_name LIKE :match or middle_name LIKE :match or last_name LIKE :match) and is_deleted = :is_del';
		$criteria_1->params = array(':match' => $_POST['char'].'%',':is_del' => 0);
