...
class Employees extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, employee_category_id, employee_number, joining_date, first_name, middle_name, last_name, gender, job_title, employee_position_id, employee_department_id, reporting_manager_id, employee_grade_id, qualification, experience_detail, experience_year, experience_month, status, status_description, date_of_birth, marital_status, children_count, father_name, mother_name, husband_name, blood_group, nationality_id, home_address_line1, home_address_line2, home_city, home_state, home_country_id, home_pin_code, office_address_line1, office_address_line2, office_city, office_state, office_country_id, office_pin_code, office_phone1, office_phone2, mobile_phone, home_phone, email, fax, photo_file_name,
			 photo_content_type, photo_data, created_at, updated_at, photo_file_size, user_id', 'safe', 'on'=>'search'),
	...
	public function attributeLabels()
	{
		return array(
			'id' => 'ID',
			'employee_category_id' => Yii::t('employees','Employee Category'),
			'employee_number' => Yii::t('employees','Employee Number'),
			'joining_date' => Yii::t('employees','Joining Date'),
			'first_name' => Yii::t('employees','First Name'),
			'middle_name' => Yii::t('employees','Middle Name'),
			'last_name' => Yii::t('employees','Last Name'),
			'gender' => Yii::t('employees','Gender'),
			'job_title' => Yii::t('employees','Job Title'),
			'employee_position_id' => Yii::t('employees','Employee Position'),
			'employee_department_id' => Yii::t('employees','Employee Department'),
			'reporting_manager_id' => Yii::t('employees','Reporting Manager'),
			'employee_grade_id' => Yii::t('employees','Employee Grade'),
			'qualification' => Yii::t('employees','Qualification'),
			'experience_detail' => Yii::t('employees','Experience Detail'),
			'experience_year' => Yii::t('employees','Experience Year'),
			'experience_month' => Yii::t('employees','Experience Month'),
			'status' => Yii::t('employees','Status'),
			'status_description' => Yii::t('employees','Status Description'),
			'date_of_birth' => Yii::t('employees','Date Of Birth'),
			'marital_status' => Yii::t('employees','Marital Status'),
			'children_count' => Yii::t('employees','Children Count'),
			'father_name' => Yii::t('employees','Father Name'),
			'mother_name' => Yii::t('employees','Mother Name'),
			'husband_name' => Yii::t('employees','Husband Name'),
			'blood_group' => Yii::t('employees','Blood Group'),
			'nationality_id' => Yii::t('employees','Nationality'),
			'home_address_line1' => Yii::t('employees','Home Address Line1'),
			'home_address_line2' => Yii::t('employees','Home Address Line2'),
			'home_city' => Yii::t('employees','Home City'),
			'home_state' => Yii::t('employees','Home State'),
			'home_country_id' => Yii::t('employees','Home Country'),
			'home_pin_code' => Yii::t('employees','Home Pin Code'),
			'office_address_line1' => Yii::t('employees','Office Address Line1'),
			'office_address_line2' => Yii::t('employees','Office Address Line2'),
			'office_city' => Yii::t('employees','Office City'),
			'office_state' => Yii::t('employees','Office State'),
			'office_country_id' => Yii::t('employees','Office Country'),
			'office_pin_code' => Yii::t('employees','Office Pin Code'),
			'office_phone1' => Yii::t('employees','Office Phone1'),
			'office_phone2' => Yii::t('employees','Office Phone2'),
			'mobile_phone' => Yii::t('employees','Mobile Phone'),
			'home_phone' => Yii::t('employees','Home Phone'),
			'email' => Yii::t('employees','Email'),
			'fax' => Yii::t('employees','Fax'),
			'photo_file_name' => Yii::t('employees','Photo File Name'),
			'photo_content_type' => Yii::t('employees','Photo Content Type'),
			'photo_data' => Yii::t('employees','Photo Data'),
			'created_at' => 'Created At',
			'updated_at' => 'Updated At',
			'photo_file_size' => Yii::t('employees','Photo File Size'),
			'user_id' => 'User',
		);
	}
