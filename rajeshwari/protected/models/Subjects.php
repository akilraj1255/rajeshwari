...
class Subjects extends CActiveRecord
{
	...
	public function attributeLabels()
	{
		return array(
			'id' => 'ID',
			'name' => Yii::t('Subjects','Name'),
			'code' => Yii::t('Subjects','Code'),
			'batch_id' => Yii::t('Subjects','Batch'),
			'no_exams' => Yii::t('Subjects','No Exams'),
			'max_weekly_classes' => Yii::t('Subjects','Max Weekly Classes'),
			'elective_group_id' => Yii::t('Subjects','Elective Group'),
