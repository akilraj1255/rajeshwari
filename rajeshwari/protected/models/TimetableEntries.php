...
class TimetableEntries extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
		    array('batch_id, weekday_id, subject_id', 'required'),
	...
	public function attributeLabels()
	{
		return array(
			'id' => 'ID',
			'batch_id' => Yii::t('timetable','Batch'),
			'weekday_id' => Yii::t('timetable','Weekday'),
			'class_timing_id' => Yii::t('timetable','Class Timing'),
			'subject_id' => Yii::t('timetable','Subject'),
			'employee_id' => Yii::t('timetable','Employee'),
		);
	}
