...
class EmployeeAttendances extends CActiveRecord
{
	...
	public function attributeLabels()
	{
		return array(
			'id' => 'ID',
			'attendance_date' => Yii::t('employees','Attendance Date'),
			'employee_id' => Yii::t('employees','Employee'),
			'employee_leave_type_id' => Yii::t('employees','Employee Leave Type'),
			'reason' => Yii::t('attendance','Reason'),
			'is_half_day' => Yii::t('attendance','Is Half Day'),
		);
	}
