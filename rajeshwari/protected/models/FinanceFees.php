...
class FinanceFees extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('fee_collection_id, student_id, fees_paid, is_paid', 'numerical', 'integerOnly'=>true),
	...
	public function attributeLabels()
	{
		return array(
			'id' => 'ID',
			'fee_collection_id' => Yii::t('fees','Fee Collection'),
			'transaction_id' => Yii::t('fees','Transaction'),
