...
<div id="electives_form_con" class="client-val-form">
    <?php if ($model->isNewRecord) : ?>    <h3 id="create_header">Create New Electives</h3>
    <?php  elseif (!$model->isNewRecord):  ?>    <h3 id="update_header">Update Electives <?php  echo
        $model->id;  ?>  </h3>
    <?php   endif;  ?>
    <?php      $val_error_msg = 'Error.Electives was not saved.';
    $val_success_message = ($model->isNewRecord) ?
            'Electives was created successfuly.' :
            'Electives  was updated successfuly.';
  ?>
...
<?php   $formId='electives-form';
   ...
   ($model->isNewRecord)?CController::createUrl('electives/ajax_create')
    ...
    <div class="row">
        ...
        <span id="success-Electives_created_at"
              class="hid input-notification-success  success png_bg right"></span>
        <div>
            <small></small>
        </div>
        ...
        <span id="success-Electives_updated_at"
              class="hid input-notification-success  success png_bg right"></span>
        <div>
            <small></small>
        </div>
