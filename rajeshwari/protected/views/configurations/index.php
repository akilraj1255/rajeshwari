    	...
    	<div class="setbx_bot">
    		<ul>
                ...
                <li><?php echo CHtml::link(Yii::t('settings','News &amp; Events<span>Create/View Events</span>'), array('/cal'),array('class'=>'icon20')) ?></li>
                 <li><?php echo CHtml::link(Yii::t('settings','Translation<span>Language Translation</span>'), array('/translate/edit/missing'),array('class'=>'icon20')) ?></li>
...
<div class="setbx" style="width:700px;">
    ...
    <div class="setbx" style="width:700px;">
    	...
    	<div class="setbx_bot">
    		<ul>
    			<li><?php echo CHtml::link(Yii::t('settings','SMS Settings<span>Enable SMS, Send SMS notifications</span>'), array('smsSettings/create'),array('class'=>'icon19')) ?></li>
			</ul>
    	</div>
    	<div class="clear"></div>
    	</div>
