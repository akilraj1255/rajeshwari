	...
	<div class="sd_left">
        ...
        <ul>
        	<li <?php if($setup_stu==true){?>class="completed"<?php }?>><?php echo CHtml::link(Yii::t('app','Students'), array('/students')); ?></li>
          	...
          	<li <?php if($setup_fee==true){?>class="completed"<?php }?>><?php echo CHtml::link(Yii::t('app','Fees'), array('/fees')); ?></li>
          	<li <?php if($setup_tim==true){?>class="completed"<?php }?>><?php echo CHtml::link(Yii::t('app','Timetable'), array('/timetable')); ?></li>
          	<li <?php if($setup_lib==true){?>class="completed"<?php }?>><?php echo CHtml::link(Yii::t('app','Library'), array('/library')); ?></li>
          	<li <?php if($setup_hos==true){?>class="completed"<?php }?>><?php echo CHtml::link(Yii::t('app','Hostel'), array('/hostel')); ?></li>
          	<li <?php if($setup_tra==true){?>class="completed"<?php }?>><?php echo CHtml::link(Yii::t('app','Transport'), array('/transport')); ?></li>
        </ul>
        </div>
    </div>
    <div class="sd_right">
