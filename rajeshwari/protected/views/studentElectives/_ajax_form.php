...
<div id="student-electives_form_con" class="client-val-form">
    <?php if ($model->isNewRecord) : ?>    <h3 id="create_header">Create New StudentElectives</h3>
    <?php  elseif (!$model->isNewRecord):  ?>    <h3 id="update_header">Update StudentElectives <?php  echo
        $model->id;  ?>  </h3>
    <?php   endif;  ?>
    <?php      $val_error_msg = 'Error.StudentElectives was not saved.';
    $val_success_message = ($model->isNewRecord) ?
            'StudentElectives was created successfuly.' :
            'StudentElectives  was updated successfuly.';
  ?>
