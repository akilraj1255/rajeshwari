...
<div id="elective-groups_form_con" class="client-val-form">
    <?php if ($model->isNewRecord) : ?>    <h3 id="create_header">Create New ElectiveGroups</h3>
    <?php  elseif (!$model->isNewRecord):  ?>    <h3 id="update_header">Update ElectiveGroups <?php  echo
        $model->id;  ?>  </h3>
    <?php   endif;  ?>
    <?php      $val_error_msg = 'Error.ElectiveGroups was not saved.';
    $val_success_message = ($model->isNewRecord) ?
            'ElectiveGroups was created successfuly.' :
            'ElectiveGroups  was updated successfuly.';
  ?>
...
<?php   $formId='elective-groups-form';
   $actionUrl =
   ($model->isNewRecord)?CController::createUrl('electiveGroups1/ajax_create')
                                                                 :CController::createUrl('electiveGroups1/ajax_update');
    ...
    <div class="row">
        ...
        <span id="success-ElectiveGroups_created_at"
              class="hid input-notification-success  success png_bg right"></span>
        <div>
            <small></small>
        </div>
        ...
        <span id="success-ElectiveGroups_updated_at"
              class="hid input-notification-success  success png_bg right"></span>
        <div>
            <small></small>
        </div>
