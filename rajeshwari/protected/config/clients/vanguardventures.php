...
define('BASEURL', 'http://vanguardventures.tryopenschool.com//');

//Database connections
define('DB_CONNECTION','mysql:host=localhost;port=3306;dbname=vanguard_os');
define('DB_USER','vanguard');
define('DB_PWD','WIw0@ekm!#$12:47');
