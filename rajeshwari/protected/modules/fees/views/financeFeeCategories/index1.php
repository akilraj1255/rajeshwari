...
function batch()
{
 ...
 window.location= 'index.php?r=fees/financeFeeCategories/index&FinanceFeeCategories[id]='+id;	
}
</script>
                ...
                success: function(data) {
                    $.fancybox(data,
                            {    "transitionIn"    :  "elastic",
                                ...
                                $.fn.yiiGridView.update('finance-fee-categories-grid', {url:'<?php echo Yii::app()->request->baseUrl;?>/index.php?r=fees/financeFeeCategories/index&FinanceFeeCategories[id]=<?php echo $_REQUEST['FinanceFeeCategories']['id'];?>',data:{"FinanceFeeCategories_page":page}});
                                }//onclosed
                            });//fancybox
                    //  console.log(data);
                } //success
