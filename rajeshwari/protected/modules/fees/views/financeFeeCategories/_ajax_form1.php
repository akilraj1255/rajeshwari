...
<div id="finance-fee-categories_form_con" class="client-val-form">
    <?php if ($model->isNewRecord) : ?>    <h3 id="create_header"><?php echo Yii::t('fees','Create New FinanceFeeCategories');?></h3>
    <?php  elseif (!$model->isNewRecord):  ?>    <h3 id="update_header"><?php echo Yii::t('fees','Update FinanceFeeCategories');?> <?php  echo
        $model->id;  ?>  </h3>
    <?php   endif;  ?>
