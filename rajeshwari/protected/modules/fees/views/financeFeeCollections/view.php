...
<h1><?php echo Yii::t('fees','View Finance Fee Collections');?> </h1>
<?php /*?>
...
<table width="100%" border="0" cellspacing="1" cellpadding="0">
  <tr>
    ...
    <tr>
    <td><?php echo Yii::t('fees','start Date');?></td>
    <td><?php
    ...
    <tr>
    <td><?php echo Yii::t('fees','End Date');?></td>
    <td><?php
			if($settings!=NULL)
								{	
