...
<div id="fee-collection-particulars_form_con" class="client-val-form">
    <?php if ($model->isNewRecord) : ?>    <h3 id="create_header"><?php echo Yii::t('fees','Create New fee Collection Particulars');?></h3>
    <?php  elseif (!$model->isNewRecord):  ?>    <h3 id="update_header"><?php echo Yii::t('fees','Update');?></h3>
    <?php   endif;  ?>
    <?php      $val_error_msg = Yii::t('fees','Error.fee Collection Particulars was not saved.');
    $val_success_message = ($model->isNewRecord) ?
            Yii::t('fees','fee Collection Particulars was created successfuly.') :
            Yii::t('fees','fee Collection Particulars  was updated successfuly.');
  ?>
