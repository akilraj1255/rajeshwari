...
echo '<strong>'.Yii::t('library','Student Admission No').'</strong></td><td>';
...
echo CHtml::dropDownList('BookID','',CHtml::listData($data,'id','admission_no'),array('prompt'=>'Select','id'=>'book_id','submit'=>array('/library/ReturnBook/manage')));
