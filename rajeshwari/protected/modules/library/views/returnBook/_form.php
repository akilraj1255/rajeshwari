...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td><?php echo $form->labelEx($model,Yii::t('library','student_id')); ?></td>
    <td>&nbsp;</td>
    <td><?php echo $form->textField($model,'student_id',array('value'=>$student->last_name.' '.$student->first_name)); ?>
  ...
  <tr>
    <td><?php echo $form->labelEx($model,Yii::t('library','book_id')); ?></td>
    <td>&nbsp;</td>
  ...
  <tr>
    <td><?php echo $form->labelEx($model,Yii::t('library','return_date')); ?></td>
    <td>&nbsp;</td>
