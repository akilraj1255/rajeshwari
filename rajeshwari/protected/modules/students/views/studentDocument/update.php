...
$this->breadcrumbs=array(
	'Student'=>array('students/view','id'=>$student_id),
	$model->title,
	'Update',
);
        ...
        <td valign="top">
        	<div class="cont_right formWrapper">
            	 <h1 style="margin-top:.67em;">
					...
					echo Yii::t('students','Student Profile :');?> <?php echo ucfirst($student->first_name).' '.ucfirst($student->middle_name).' '.ucfirst($student->last_name); ?><br />
                </h1>
				<div class="clear"></div>
					...
					<div class="emp_tabwrapper">
                        ...
                        <div class="emp_cntntbx">
                        	<div class="edit_bttns last">
                                <ul>
                                    <li>
                                        <?php echo CHtml::link(Yii::t('students','<span>Document List</span>'), array('students/document', 'id'=>$student_id),array('class'=>' edit ')); ?>
                                    </li>
                                </ul>
