...
<?php $form=$this->beginWidget('CActiveForm', array(
    ...
    <div class="formCon" style="clear:left;">
        <div class="formConInner" id="innerDiv">
        	<table width="80%" border="0" cellspacing="0" cellpadding="0" id="documentTable">
            	<tr>
                	<td width="10%"><?php echo $form->labelEx($model,Yii::t('students','Document Name')); ?></td>
                    <td>&nbsp;</td>
                ...
                <tr>
                    ...
                    <td id="existing_file">
                        ...
                        <ul class="tt-wrapper">
                            <li>
                                <?php echo CHtml::link('<span>View</span>', array('studentDocument/download','id'=>$model->id,'student_id'=>$model->student_id),array('class'=>'tt-download')); ?>
                            </li>
                            <li>
    ...
    <div class="row buttons">
        ...
        <?php echo CHtml::submitButton('Update',array('class'=>'formbut')); ?>
    </div>
