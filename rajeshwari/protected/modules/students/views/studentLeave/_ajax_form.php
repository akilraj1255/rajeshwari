...
<?php   $formId='student-attentance-form';
   ...
   ($model->isNewRecord)?CController::createUrl('studentLeave/ajax_create')
	...
	$date = 'dd-mm-yy';	
			...
			?>
        <span style="margin-top:0px; position: relative; right:-3px; top:-23px;"  id="success-StudentAttentance_date"
              class="hid input-notification-success  success png_bg right"></span>
        <div>
            <small></small>
        </div>
        ...
        <span style="margin-top:0px; position: relative; right:-3px; top:-23px;"  id="success-StudentAttentance_reason"
              class="hid input-notification-success  success png_bg right"></span>
        <div>
            <small></small>
        </div>
