			...
			function t($message, $category = 'cms', $params = array(), $source = null, $language = null) 
{
    return $message;
			...
			'items'=>array(
					...
					array('label'=>''.Yii::t('translate','Manage Translation<span>Manage Translation</span>'),  'url'=>array('/translate/edit'),'linkOptions'=>array('class'=>'gs_ico' ), 'itemOptions'=>array('id'=>'menu_1'),'active'=> ((Yii::app()->controller->id=='edit' and Yii::app()->controller->action->id=='admin') ? true : false), 
					       ),
						 
						 
						 
						  array('label'=>Yii::t('settings','Translate<span>Manage Translation</span>'), 'url'=>array('/translate/edit/missing'),'linkOptions'=>array('class'=>'sm_ico' )),
