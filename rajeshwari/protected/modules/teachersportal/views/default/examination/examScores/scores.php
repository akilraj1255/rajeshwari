...
<?php
	...
	$batch=Batches::model()->findByAttributes(array('id'=>$batch_id));
					...
					<div class="formConInner">
                    	<table cellspacing="5px">
                        	<tr>
                               ...
                               <td>
                                    <strong><?php echo Yii::t('examination','Batch'); ?>: </strong><?php echo $batch->name; ?>
                        		</td>
                        	</tr>
                            <tr>
							...
							?>
								<td>
									<strong><?php echo Yii::t('examination','Subject'); ?>: </strong><?php echo $subject->name;  ?>
								</td>
							<?php
							}
							?>
							...
							?>
								<td>
                                	<strong><?php echo Yii::t('examination','Subject Teacher'); ?>: </strong><?php echo $subject_teacher->first_name.' '.$subject_teacher->last_name; ?>
								</td>
							<?php
							}
							...
							?>
                            	<td>
                                	<strong><?php echo Yii::t('examination','Class Teacher'); ?>: </strong><?php echo $classteacher->first_name.' '.$classteacher->last_name; ?>
								</td>
                            <?php
							}
							?>
        ...
        <ul>
            ...
            <li>
            <?php 
				echo CHtml::link('<span>'.Yii::t('examination','View Subject List').'</span>', array($url,'bid'=>$batch_id,'exam_group_id'=>$exam_group_id,'r_flag'=>1),array('id'=>'add_exam-groups','class'=>'addbttn')); 
            ...
            <li>
            <?php 
				echo CHtml::link('<span>'.Yii::t('examination','View Exam List').'</span>', array($url,'bid'=>$batch_id),array('id'=>'add_exam-groups','class'=>'addbttn')); 
			...
			?>
            <li>
        	<?php echo CHtml::link('<span>'.Yii::t('examination','Change Batch').'</span>', array($url),array('id'=>'add_exam-groups','class'=>'addbttn')); ?>
        	</li>
        </ul>
        <div class="clear"></div>
    </div>
    ...
    <div class="formCon">
		...
		?>
                ...
                <div>
					...
					if($i==1)
					{
						 echo '<div class="notifications nt_green">'.Yii::t('examination','<i>Exam Score Entered For All Students</i>').'</div>'; 
						 ...
						 echo '<div class="notifications nt_green">Class Average = '.$avg.' marks</div>';
