<div style="width:800px; padding-left:20px;"><br/><br/>
    ...
    if($exam_group_id==NULL){ // If $exam_group_id == NULL, list of exams will be displayed
		...
		$this->widget('zii.widgets.grid.CGridView', array(
			...
			array(
			'class'=>'CLinkColumn',
			'labelExpression'=>'$data->is_published ? "View Schedule" : "Not scheduled"',
			...
			array(
			'class'=>'CLinkColumn',
			'labelExpression'=>'$data->result_published ? "View Results" : ($data->is_published ? "Enter Scores" : "No Results Published")',
		...
		//echo '<br/>Exam Group ID: '.$exam_group_id.'<br/>';
			...
			<?php $model1=new Exams('search');
				  ...
				  ?>
				  <h3> <?php echo Yii::t('examination','Scheduled Subjects'); ?></h3>
