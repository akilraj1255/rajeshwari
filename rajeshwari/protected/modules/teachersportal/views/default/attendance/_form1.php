...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row buttons">
		<?php //echo CHtml::submitButton($model->isNewRecord ? 'Create' : 'Save'); ?>
         <?php echo CHtml::ajaxSubmitButton(Yii::t('Attendance','Save'),CHtml::normalizeUrl(array('/teachersportal/default/EditLeave','render'=>false)),array('success'=>'js: function(data) {
						$("#td'.$day.$emp_id.'").text("");
     ...
     <?php echo CHtml::ajaxSubmitButton(Yii::t('Attendance','Delete'),CHtml::normalizeUrl(array('/teachersportal/default/DeleteLeave','render'=>false)),array('success'=>'js: function(data) {
		                $("#td'.$day.$emp_id.'").text(" ");
		                $("#jobDialog'.$day.$emp_id.'").dialog("close"); window.location.reload();
