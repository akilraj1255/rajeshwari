    ...
    <div class="right_col"  id="req_res123">                                      
        ...
        <div id="parent_rightSect">
            <div class="parentright_innercon">
                <h1><?php echo Yii::t('Attendance','View Attendance'); ?></h1>
                <div>
                ...
                <div class="yellow_bx" style="background-image:none;width:90%;padding-bottom:45px;">
                    ...
                    <div class="y_bx_list timetable_list">
                    	<h2><?php echo Yii::t('Attendance','View My Attendance'); ?></h2>
                        <p><?php echo Yii::t('Attendance','Displays your attendance status.'); ?></p>
                    </div> 
                    <?php 
					if($stud_flag == 1)
					{
					?>
                    <div class="y_bx_list timetable_list">
                    	<h2><?php echo Yii::t('Attendance','Manage Student Attendance'); ?></h2>
                        <p><?php echo Yii::t('Attendance','View/Mark/Edit/Delete the attendance of the students of your batch.'); ?></p>
                    </div>
