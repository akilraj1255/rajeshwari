...
<div style="padding-left:20px;" class="sms-block">
    <h1><?php echo Yii::t('os_sms_module','Create Sms');?></h1> 
    ...
    <table cellpadding="0">
    	<tr>
        	<td>
                ...
                Browse from <a href="javascript:void(0);" id="browse_from_file">file</a> or <a href="javascript:void(0);" id="browse_from_contacts">contacts</a>
            </td>
        </tr>
        <tr>
        	<td>
        ...
        <tr>
        	<td>
            	<textarea placeholder="Message here..." name="message" id="message" style="width:390px !important; height:120px;"></textarea>
            </td>
        </tr>
        <tr>
        	<td>
    ...
    <div class="right" style="">
    	<h2><?php echo Yii::t('os_sms_module','Use Templates');?></h2>
        <div class="sms-templates">
			...
			?>
            <div class="sms-template"><?php echo Yii::t('os_sms_module', 'No templates found, create a template').' '.CHtml::link(Yii::t('os_sms_module', 'now'), array('/mailbox/smstemplates/create'));?></div>
			<?php
			}
			?>
        </div>
