...
<div id="contact-groups_form_con" class="client-val-form">
    <?php if ($model->isNewRecord) : ?>    <h3 id="create_header">Create New Contact Group</h3>
    <?php  elseif (!$model->isNewRecord):  ?>    <h3 id="update_header">Update Contact Group </h3>
    <?php   endif;  ?>
    <?php      $val_error_msg = 'Error.Contact Group was not saved.';
    $val_success_message = ($model->isNewRecord) ?
            'Contact Group was created successfuly.' :
            'Contact Group was updated successfuly.';
  ?>
