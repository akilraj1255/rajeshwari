...
$this->breadcrumbs=array(
	...
	Yii::t('os_sms_module','Contact Groups'),
);
?>
<style>
                ...
                <tbody><tr>
                    <td width="75%" valign="top">
                    	<div style="padding-left:20px;" class="sms-block">
    						<h1><?php echo Yii::t('os_sms_module','Contact Groups');?></h1>
                            <div style="position:relative;">
                                <div class="contrht_bttns" style="right:9px;">
                                    <ul>
                                        <li>
                                            <?php echo CHtml::link('<span>'.Yii::t('os_sms_module','Create a group').'</span>', array('#'),array('class'=>'saveic', 'id'=>'add_contact-groups'));?>
                                        </li>
                                	</ul>
                                </div>
                            </div>           
                            ...
                            <ul>
                            <li>
                                <a href="javascript:void(0);" id="delete_groups">Delete</a>
                            </li>
                            </ul>
                            </div>
                            <!--extra options-->
							...
							?>
							<div style="padding-top:10px" class="notifications nt_red"><i><?php echo Yii::t('os_sms_module','No groups found');?></i></div>
							<?php
							}
							?>
                            <div class="clear"></div>
