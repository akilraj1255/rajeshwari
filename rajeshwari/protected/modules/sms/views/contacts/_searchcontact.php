    ...
    <form id="select-contact-form">
        ...
        <td>
            ...
            <ul>
                ...
                <li><label for="check-all-contacts">Select All</label></li>
            </ul>
            <?php
			}			
			else{
			?>
			<div style="padding-top:10px; width:94%; margin-top:10px;" class="notifications nt_red"><i><?php echo Yii::t('os_sms_module','No contacts found').'. '.CHtml::link(Yii::t('os_sms_module','Create Now'), array('/sms/contacts/create'), array('target'=>'_blank'));?></i></div>
			<?php
			}
			?>
            </div>
            ...
            <tr>
                <td >				
                <input type="button"  class="popup_contact_but" id="add-contacts-to-send-box" value="Add" /></td>
            </tr>
            <?php
			}
			?>
