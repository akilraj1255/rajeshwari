    ...
    <form id="select-group-form">
        ...
        <td>
            ...
            <ul>
                ...
                <li><label for="check-all-groups">Select All</label></li>
            </ul>
            <?php
			}			
			else{
			?>
			<div style="padding-top:10px; width:94%; margin-top:10px;" class="notifications nt_red"><i><?php echo Yii::t('os_sms_module','No groups found').'. '.CHtml::link(Yii::t('os_sms_module','Create Now'), array('/sms/contactgroups/create'), array('target'=>'_blank'));?></i></div>
			<?php
			}
			?>
            </div>
			...
			?>
            <tr>
                <td colspan="2"><input type="button" class="popup_contact_but"  id="add-groups-to-send-box" value="Add" /></td>
            </tr>
            <?php
			}
			?>
