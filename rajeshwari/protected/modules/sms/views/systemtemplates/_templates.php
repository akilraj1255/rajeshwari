...
<div class="sms-templates">
    ...
    ?>
    <div style="padding-top:10px; width:94%; margin-top:10px;" class="notifications nt_red"><i><?php echo Yii::t('os_sms_module', 'No templates found, create a template').' '.CHtml::link(Yii::t('os_sms_module', 'now'), array('/sms/templates/create'), array('target'=>'_blank'));?></i></div>
    <?php
    }
    ?>
