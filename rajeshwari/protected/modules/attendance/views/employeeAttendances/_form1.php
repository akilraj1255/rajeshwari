...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row buttons">
        ...
        <?php 
		echo CHtml::ajaxSubmitButton(Yii::t('attendance','Save'),CHtml::normalizeUrl(array('EmployeeAttendances/EditLeave','render'=>false)),array('success'=>'js: function(data) {
						$("#td'.$day.$emp_id.'").text("");
        ...
        <?php echo CHtml::ajaxSubmitButton(Yii::t('attendance','Delete'),CHtml::normalizeUrl(array('EmployeeAttendances/DeleteLeave','render'=>false)),array('success'=>'js: function(data) {
		                $("#td'.$day.$emp_id.'").text(" ");
