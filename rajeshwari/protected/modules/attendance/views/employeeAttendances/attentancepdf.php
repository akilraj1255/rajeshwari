...
//echo CHtml::dropDownList('batch_id','',CHtml::listData(Subjects::model()->findAll("batch_id=:x",array(':x'=>$_REQUEST['id'])), 'id', 'name'), array('empty'=>'Select Type'));
  ...
  if(isset($_REQUEST['id']))
  {
    ...
    <!-- End Header -->
    <br /><br />
    <span align="center"><h4><?php echo Yii::t('attendance','EMPLOYEE ATTENDANCE'); ?></h4></span>
    <!-- Department details -->
    <div style="border:#CCC 1px; width:700px; padding:10px 10px; background:#E1EAEF;">
        <table style="font-size:14px;">
            ...
            ?>
            <tr>
                <td style="width:100px;"><b><?php echo Yii::t('attendance','Department'); ?></b></td>
            ...
            <tr>
				...
				?>
                <td><b><?php echo Yii::t('attendance','Total Employees'); ?></b></td>
                <td>:</td>
