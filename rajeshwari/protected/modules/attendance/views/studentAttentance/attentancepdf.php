...
//echo CHtml::dropDownList('batch_id','',CHtml::listData(Subjects::model()->findAll("batch_id=:x",array(':x'=>$_REQUEST['id'])), 'id', 'name'), array('empty'=>'Select Type'));
  ...
  if(isset($_REQUEST['id']))
  {
            ...
            <tr>
                ...
                <td align="center" valign="middle" class="first" style="width:300px;">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                            <td class="listbxtop_hdng first" style="text-align:left; font-size:14px; padding-left:10px;">
                                <?php echo Yii::t('attendance','Phone: ').$college[2]->config_value; ?>
                            </td>
                        </tr>
                    </table>
                </td>
    ...
    <br /><br />
    <span align="center"><h4><?php echo Yii::t('attendance','CLASS STUDENT ATTENDANCE'); ?></h4></span>
    ...
    <div style="border:#CCC 1px; width:700px; padding:10px 10px; background:#E1EAEF;">
        <table style="font-size:14px;">
            ...
            <tr>
				...
				?>
                <td style="width:100px;"><b><?php echo Yii::t('attendance','Course'); ?></b></td>
                ...
                <td><b><?php echo Yii::t('attendance','Batch'); ?></b></td>
                <td>:</td>
                <td>
					<?php 
					if($batch->name!=NULL)
            ...
            <tr>
            	<td><b><?php echo Yii::t('attendance','Total Students'); ?></b></td>
                <td>:</td>
                <td>
					<?php 
					if($students!=NULL)
            	...
            	<td><b><?php echo Yii::t('attendance','Month'); ?></b></td>
                <td>:</td>
