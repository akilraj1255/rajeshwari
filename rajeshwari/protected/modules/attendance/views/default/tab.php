 ...
 <?php    $batch=Batches::model()->findByAttributes(array('id'=>$_REQUEST['id'])); 
	...
	<div class="c_batch_tbar">
      <div class="edit_bttns" style="width:350px; top:-40px; right:-25px;">
            	<ul>
                <li>
                   <?php echo CHtml::link('<span>'.Yii::t('attendance','Employee Attendance').'</span>',array('/attendance/employeeAttendances'),array('class'=>'addbttn','style'=>'top:-40px;'));?>
...
<?php 
    	...
    	<div class="cb_left">
        	<ul>
            	<li><strong><?php echo Yii::t('attendance','Course / Batch: '); ?></strong> <?php echo $coursename; ?> / <?php echo $batchname; ?></li>
        ...
        <div class="cb_right" style="width:290px">
        	<div class="status_bx" style="width:290px">
    			<ul>
        			<li><span><?php echo count(Students::model()->findAll("batch_id=:x", array(':x'=>$_REQUEST['id']))); ?></span><?php echo Yii::t('attendance','Student(s)');?></li>
            		<li><span><?php echo count(Subjects::model()->findAll("batch_id=:x", array(':x'=>$_REQUEST['id']))); ?></span><?php echo Yii::t('attendance','Subject(s)');?></li>
            		<li><span><?php echo count(TimetableEntries::model()->findAll(array('condition'=>'batch_id=:x', 'group'=>'employee_id','params'=>array(':x'=>$_REQUEST['id'])))); ?></span><?php echo Yii::t('attendance','Employee(s)');?></li>
        		</ul>
     		<div class="clear"></div>
   			</div>
