      ...
      <div id="parent_Sect">
        ...
        <div id="parent_rightSect">
        	<div class="parentright_innercon">
            	<h1><?php echo Yii::t('studentportal','Inbox'); ?></h1>
                <?php 
                ...
                <div class="inbox_filter">
                	<ul>
                        ...
                        <li><a href="#"><?php echo Yii::t('studentportal','Mark as Read'); ?></a></li>
                        <li><a href="#"><?php echo Yii::t('studentportal','Mark as Unread'); ?></a></li>
                        <li><a href="#"><?php echo Yii::t('studentportal','Delete'); ?></a></li>
                        <li><a href="#"><?php echo Yii::t('studentportal','Archive'); ?></a></li>
                    </ul>
                    <div class="clear"></div>
                </div>
                <?php
