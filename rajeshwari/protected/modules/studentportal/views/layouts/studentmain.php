    ...
    <body>
            ...
            <div class="loginBox">
                <ul>
                    <li>
                        ...
                        <br><?php echo CHtml::link(Yii::t('studentportal','Logout'), array('/user/logout'));?><br>
                    </li>
                    <li>
                        <?php
        ...
        <nav>
            <div style="padding:7px 0px;">
              <?php echo Yii::t('studentportal','Welcome'); ?> <strong><?php echo ucfirst($student->last_name.' '.$student->first_name);?></strong> <?php echo Yii::t('studentportal','in to your profile.'); ?>
            </div> 	
        </nav>
        ...
        <footer>
        <div class="fright">
        	<div class="cright"><?php echo Yii::t('studentportal','Copyright'); ?> © 2012 <?php echo $college->config_value; ?>. <?php echo Yii::t('studentportal','Powered By'); ?> <a href="http://www.wiwoinc.com" target="_blank"><?php echo Yii::t('studentportal','WIWO Inc'); ?></a>. </div>
        </div>
        </footer>
    </body>
</html>
