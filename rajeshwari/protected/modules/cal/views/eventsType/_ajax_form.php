...
<div id="events-type_form_con" class="client-val-form">
    <?php if ($model->isNewRecord) : ?>    <h3 id="create_header"><?php echo Yii::t('cal','Create New Event Type');?></h3>
    <?php  elseif (!$model->isNewRecord):  ?>    <h3 id="update_header"><?php echo Yii::t('cal','Update Event Type');?>   </h3>
    <?php   endif;  ?>
    <?php      $val_error_msg = Yii::t('cal','Error.EventsType was not saved.');
    $val_success_message = ($model->isNewRecord) ?
            Yii::t('cal','Event Type was created successfuly.') :
            Yii::t('cal','Event Type  was updated successfuly.');
  ?>
...
<?php   $formId='events-type-form';
   ...
   ($model->isNewRecord)?CController::createUrl('eventsType/ajax_create')
    ...
    <div style="font-weight:bold">'.Yii::t('cal','Please correct these errors:').'</div>
    ', NULL, array('class' => 'errorsum notification errorshow png_bg')); ?>    <p class="note"> <?php echo Yii::t('cal','Fields with');?> <span class="required">*</span><?php echo Yii::t('cal','are required.');?></p>
    ...
    <div class="row buttons">
        <?php   echo CHtml::submitButton($model->isNewRecord ? Yii::t('cal','Submit') : Yii::t('cal','Save'),array('class' =>
        'formbut')); ?>    </div>
