            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <div class="cont_right formWrapper">
                        <h1><?php echo Yii::t('cal','Events Types'); ?></h1>
                        <div class="edit_bttns">
                        	<ul>
                            	<li>
                                    <!--<input id="add_events-type" type="button" style="display:block; clear: both;"
                                    value="Create EventsType" class="addbttn last">-->
                                    <?php echo CHtml::link('<span>'.Yii::t('cal','Create Event Type').'</span>', array('#'),array('id'=>'add_events-type','class'=>'addbttn')) ?>
                            	</li>
							</ul>
                        </div>
                        ...
                        $del_con = Yii::t('cal', 'Are you sure you want to delete this events-type?');
                        $del_title=Yii::t('cal', 'Delete Confirmation');
                        $del=Yii::t('cal', 'Delete');
                        $cancel=Yii::t('cal', 'Cancel');
                        ?>
                        <?php
                        ...
                        'buttons' => array(
                                 ...
                                 'label' => Yii::t('cal', 'Delete'), // text label of the button
                                 ...
                                 'label' => Yii::t('cal', 'Update'), // text label of the button
                                 'url' => '$data->id', // a PHP expression for generating the URL of the button
                                 ...
                                 'events-type_view' => array(
                                  'label' => Yii::t('cal', 'View'), // text label of the button
                                  'url' => '$data->id', // a PHP expression for generating the URL of the button
