  <div id="parent_leftSect">
          ...
          <?php
			...
			{
				echo CHtml::link(Yii::t('studentportal','Calender'),array('/studentportal/default/eventlist'),array('class'=>'attendance_active'));
			}
			else
			{
				echo CHtml::link(Yii::t('studentportal','Calender'),array('/studentportal/default/eventlist'),array('class'=>'attendance'));
			}
           ...
           <?php
			...
			{
				echo CHtml::link('Library',array('/library/book/manage'),array('class'=>'library_active'));
			}
			else
			{
				echo CHtml::link('Library',array('/library/book/manage'),array('class'=>'library'));
			}
		   ?>
           </li>        
           <?php 
			/*$modules=ModuleSettings::model()->findAll();
			if($modules[10]->is_enabled=='1'){*/
			?> 
           <li>
           <?php
				if(Yii::app()->controller->module->id=='hostel' and (Yii::app()->controller->action->id=='index' or Yii::app()->controller->action->id=='change' or Yii::app()->controller->id=='room'))
				{
					echo CHtml::link('Hostel',array('/hostel'),array('class'=>'hostel_active'));
				}
				else
				{
					echo CHtml::link('Hostel',array('/hostel'),array('class'=>'hostel'));
				}
			//}
		   ?>
           </li>
