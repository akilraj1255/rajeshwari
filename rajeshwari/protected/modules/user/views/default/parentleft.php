  <div id="parent_leftSect">
			...
			{
				echo CHtml::link(Yii::t('companyportal','Events'),array('/dashboard/default/events'),array('class'=>'events_active'));
			}
			else
			{
				echo CHtml::link(Yii::t('companyportal','Events'),array('/dashboard/default/events'),array('class'=>'events'));
			}
           ?>
            </li>
                <li>
			...
			{
				echo CHtml::link(Yii::t('companyportal','Calender'),array('/parentportal/default/eventlist'),array('class'=>'cal_active'));
			}
			else
			{
				echo CHtml::link(Yii::t('companyportal','Calender'),array('/parentportal/default/eventlist'),array('class'=>'cal'));
			}
           ...
           <?php
				...
				{
					echo CHtml::link(Yii::t('Users','Settings'),array('/user/profile'),array('class'=>'settings_active'));
				}
				else
				{
		   			echo CHtml::link(Yii::t('Users','Settings'),array('/user/profile'),array('class'=>'settings'));
				}
		   ?>
           </li>         
