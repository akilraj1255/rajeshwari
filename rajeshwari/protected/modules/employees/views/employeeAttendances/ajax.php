...
if(count($find)==0)
{
	...
	*/
echo CHtml::ajaxLink('ll',$this->createUrl('employeeAttendances/Addnew'),array(
	...
	*/
    ...
    echo CHtml::ajaxLink('<span class="abs"></span>',$this->createUrl('employeeAttendances/EditLeave'),array(
        'onclick'=>'$("#jobDialog'.$day.$emp_id.'").dialog("open"); return false;',
