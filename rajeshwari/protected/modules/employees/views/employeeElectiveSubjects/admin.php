...
$this->menu=array(
	array('label'=>'List EmployeeElectiveSubjects', 'url'=>array('index')),
	array('label'=>'Create EmployeeElectiveSubjects', 'url'=>array('create')),
);
...
<h1><?php echo Yii::t('employees','Manage Employee Elective Subjects'); ?></h1>
