...
<div class="captionWrapper">
	<ul>
    	<li><h2  class="cur">1.<?php echo Yii::t('employees','Employee Admission'); ?></h2><span><?php echo Yii::t('employees','General Details'); ?></span></li>
        <li><h2>2.<?php echo Yii::t('employees','Employee Admission'); ?></h2><span><?php echo Yii::t('employees','General Details'); ?></span></li>
         <li><h2>3.<?php echo Yii::t('employees','Employee Admission'); ?></h2><span><?php echo Yii::t('employees','General Details'); ?></span></li>
         <li><h2>4.<?php echo Yii::t('employees','Employee Admission'); ?></h2><span><?php echo Yii::t('employees','General Details'); ?></span></li>
        <li class="last"><h2>5.<?php echo Yii::t('employees','Employee Admission'); ?></h2><span><?php echo Yii::t('employees','General Details'); ?></span></li>
    </ul>
</div>
<div class="formCon">
<h2><span><?php echo Yii::t('employees','Step'); ?> 1.</span> <?php echo Yii::t('employees','Employee Admission'); ?></h2>
...
<h3><?php echo Yii::t('employees','General Details'); ?></h3>
...
<div class="row">
	...
	<div class="row buttons">
		<?php echo CHtml::submitButton($model->isNewRecord ? Yii::t('employees','Create') : Yii::t('employees','Save')); ?>
	</div>
