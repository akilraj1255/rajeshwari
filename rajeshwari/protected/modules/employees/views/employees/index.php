...
<div class="overview">
	<div class="overviewbox ovbox1">
    	<h1><strong><?php echo Yii::t('employees','Total Employees');?></strong></h1>
        <div class="ovrBtm"><?php echo $total ?></div>
    </div>
    <div class="overviewbox ovbox2">
    	<h1><strong><?php echo Yii::t('employees','New Admissions');?></strong></h1>
...
<div class="clear"></div>
  ...
  <div class="pdtab_Con" style="width:97%">
                <div style="font-size:13px; padding:5px 0px"><strong><?php echo Yii::t('employees','Recent Employee Admissions');?></strong></div>
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tbody>
                    <tr class="pdtab-h">
