...
?>
	<br /><br />
    <span align="center"><h4><?php echo Yii::t('employees','EMPLOYEE PROFILE');?></h4></span>
    <table class="table_listbx" width="100%" cellspacing="0" cellpadding="0">
      
         <tr>
            <td class="listbx_subhdng odd"><strong><?php echo Yii::t('employees','Employee Name');?></strong></td>
           <td class="subhdng_nrmal odd"><?php echo ucfirst($model->first_name).' '.ucfirst($model->last_name); ?></td>    
        </tr>
        
		<tr>
            <td class="listbx_subhdng"><strong><?php echo Yii::t('employees','Joining Date');?></strong></td>
        ...
        <tr>
            <td class="listbx_subhdng odd"><strong><?php echo Yii::t('employees','Date of Birth');?></strong></td>
        ...
        <tr>
            <td class="listbx_subhdng"><strong><?php echo Yii::t('employees','Gender');?></strong></td>
        ...
        <tr>
           <td class="listbx_subhdng odd"><strong><?php echo Yii::t('employees','Department');?></strong></td>
           <td class="subhdng_nrmal odd">
		   <?php
        ...
        <tr>
           <td class="listbx_subhdng"><strong><?php echo Yii::t('employees','Position');?></strong></td>
           <td class="subhdng_nrmal">
		   <?php 
        ...
        <tr>
           <td class="listbx_subhdng odd"><strong><?php echo Yii::t('employees','Category');?></strong></td>
           <td class="subhdng_nrmal odd">
		   		<?php
        ...
        <tr>
           <td class="listbx_subhdng"><strong><?php echo Yii::t('employees','Grade');?></strong></td>
           <td class="subhdng_nrmal">
		   		<?php
        ...
        <tr>
           <td class="listbx_subhdng odd"><strong><?php echo Yii::t('employees','Job Title');?></strong></td>
           <td class="subhdng_nrmal odd">
		   		<?php
         ...
         <tr>
            <td class="listbx_subhdng"><strong><?php echo Yii::t('employees','Qualification');?></strong></td>
        ...
        <tr>
            <td class="listbx_subhdng odd"><strong><?php echo Yii::t('employees','Total Experiance');?></strong></td>
            ...
            <td class="subhdng_nrmal odd">
                ...
                elseif($model->experience_year and $model->experience_month)
                    echo $model->experience_year.' year(s) and '.$model->experience_month.' month(s)';
                else
                    echo '-';
                ?>
            </td>
        ...
        <tr>
            <td class="listbx_subhdng"><strong><?php echo Yii::t('employees','Experiance Info');?></strong></td>
        ...
        <tr>
            <td class="listbx_subhdng odd"><strong><?php echo Yii::t('employees','Nationality');?></strong></td>
        ...
        <tr>
            <td class="listbx_subhdng"><strong><?php echo Yii::t('employees','Address');?></strong></td>
        ...
        <tr>
           <td class="listbx_subhdng odd"><strong><?php echo Yii::t('employees','Email');?></strong></td>
           <td class="subhdng_nrmal odd">
		   		<?php
         ...
         <tr>
            <td class="listbx_subhdng"><strong><?php echo Yii::t('employees','Mobile No.');?></strong></td>
        ...
        <tr>
            <td class="listbx_subhdng odd"><strong><?php echo Yii::t('employees','Home Phone No.');?></strong></td>
        ...
        <tr>
            <td class="listbx_subhdng"><strong><?php echo Yii::t('employees','Office Phone 1');?></strong></td>
        ...
        <tr>
            <td class="listbx_subhdng odd"><strong><?php echo Yii::t('employees','Office Phone 2');?></strong></td>
        ...
        <tr>
            <td class="listbx_subhdng"><strong><?php echo Yii::t('employees','Fax');?></strong></td>
        ...
        <tr>
            <td class="listbx_subhdng odd"><strong><?php echo Yii::t('employees','Marital Status');?></strong></td>
        ...
        <tr>
            <td class="listbx_subhdng"><strong><?php echo Yii::t('employees','Children Count');?></strong></td>
        ...
        <tr>
            <td class="listbx_subhdng odd"><strong><?php echo Yii::t('employees','Blood Group');?></strong></td>
