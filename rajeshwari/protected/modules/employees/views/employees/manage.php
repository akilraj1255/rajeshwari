...
<div id="batch" style="display:none; width:238px; padding-top:0px; height:30px" class="drop">
<div class="droparrow" style="left:10px;"></div>
<?php 
...
<div id="cat" style="display:none; width:238px; padding-top:0px; height:30px" class="drop">
<div class="droparrow" style="left:10px;"></div>
<?php 
...
<div id="pos" style="display:none; width:238px; padding-top:0px; height:30px" class="drop">
<div class="droparrow" style="left:10px;"></div>
<?php 
...
<div id="grd" style="display:none; width:238px; padding-top:0px; height:30px; left:-140px" class="drop">
...
<div id="gender" style="display:none; width:241px; padding-top:0px; height:30px; left:-140px" class="drop">
<div class="droparrow" style="left:150px;"></div>
<?php 
...
<div id="marital" style="display:none; width:245px; padding-top:0px; height:30px; left:-100px;" class="drop">
...
<div id="bloodgroup" style="display:none; width:241px; padding-top:0px; height:30px;" class="drop" >
<div class="droparrow" style="left:10px;"></div>
...
<div id="nationality" style="display:none; width:238px; left:-180px; height:30px; padding-top:0px;" class="drop">
...
<div id="dob" style="display:none; width:390px; left:-210px; height:30px; padding-top:0px;" class="drop">
...
<div id="joining" style="display:none; width:387px; left:-190px;  height:30px; padding-top:0px;" class="drop">
...
<?php $this->endWidget(); ?>
    ...
    <div class="filterbxcntnt_left"><strong><?php echo Yii::t('employees','Active Filters:');?></strong></div>
    <div class="clear"></div>
	...
	{
		$j++; ?>
    <li><?php echo Yii::t('employees','Name');?> : <?php echo $_REQUEST['name']?><a href="<?php echo Yii::app()->request->getUrl().'&name='?>"></a></li>
    <?php } ?>
    ...
    { 
	    $j++; ?>
    <li><?php echo Yii::t('employees','Admission number');?> : <?php echo $_REQUEST['employeenumber']?><a href="<?php echo Yii::app()->request->getUrl().'&employeenumber='?>"></a></li>
    <?php } ?>
    ...
    { 
	   $j++;
	?>
    <li><?php echo Yii::t('employees','Department');?> : <?php echo EmployeeDepartments::model()->findByAttributes(array('id'=>$_REQUEST['Employees']['employee_department_id']))->name?><a href="<?php echo Yii::app()->request->getUrl().'&Employees[employee_department_id]='?>"></a></li>
    <?php } ?>
    ...
    { 
	   $j++;
	?>
    <li><?php echo Yii::t('employees','Category');?> : <?php echo EmployeeCategories::model()->findByAttributes(array('id'=>$_REQUEST['Employees']['employee_category_id']))->name?><a href="<?php echo Yii::app()->request->getUrl().'&Employees[employee_category_id]='?>"></a></li>
    <?php } ?>
    ...
    { 
	   $j++;
	?>
    <li><?php echo Yii::t('employees','Position');?> : <?php echo EmployeePositions::model()->findByAttributes(array('id'=>$_REQUEST['Employees']['employee_position_id']))->name?><a href="<?php echo Yii::app()->request->getUrl().'&Employees[employee_position_id]='?>"></a></li>
    <?php } ?>
    ...
    { 
	   $j++;
	?>
    <li><?php echo Yii::t('employees','Grade');?> : <?php echo EmployeeGrades::model()->findByAttributes(array('id'=>$_REQUEST['Employees']['employee_grade_id']))->name?><a href="<?php echo Yii::app()->request->getUrl().'&Employees[employee_grade_id]='?>"></a></li>
    <?php } ?>
	...
	$gen='Female';
	?>
    <li><?php echo Yii::t('employees','Gender');?> : <?php echo $gen?><a href="<?php echo Yii::app()->request->getUrl().'&Employees[gender]='?>"></a></li>
    <?php } ?>
	...
	{
		$j++; ?>
    <li><?php echo Yii::t('employees','Marital Status');?> : <?php echo $_REQUEST['Employees']['marital_status']?><a href="<?php echo Yii::app()->request->getUrl().'&Employees[marital_status]='?>"></a></li>
    <?php } ?>
	...
	{ 
	   $j++; ?>
    <li><?php echo Yii::t('employees','Blood Group');?> : <?php echo $_REQUEST['Employees']['blood_group']?><a href="<?php echo Yii::app()->request->getUrl().'&Employees[blood_group]='?>"></a></li>
    <?php } ?>
	...
	{
	    $j++; ?>
    <li><?php echo Yii::t('employees','Country');?> : <?php echo Countries::model()->findByAttributes(array('id'=>$_REQUEST['Employees']['nationality_id']))->name?><a href="<?php echo Yii::app()->request->getUrl().'&Employees[nationality_id]='?>"></a></li>
    <?php } ?>
    ...
    <li><?php echo Yii::t('employees','Date Of Birth');?> : <?php echo $range.' : '.$_REQUEST['Employees']['date_of_birth']?><a href="<?php echo Yii::app()->request->getUrl().'&Employees[date_of_birth]='?>"></a></li>
    <?php }} 
	...
	if(isset($_REQUEST['Employees']['joinrange']) and $_REQUEST['Employees']['joinrange']!=NULL)
    {
		if(isset($_REQUEST['Employees']['joining_date']) and $_REQUEST['Employees']['joining_date']!=NULL)
			  { $j++;
				  ...
				  ?>
     <li><?php echo Yii::t('employees','Joining Date');?> : <?php echo $joinrange.' : '.$_REQUEST['Employees']['joining_date']?><a href="<?php echo Yii::app()->request->getUrl().'&Employees[joining_date]='?>"></a></li>
    <?php }} 
...
<div class="clear"></div>
 ...
 <tr class=<?php echo $cls;?> id=<?php echo $i;?>>
    ...
    <td><?php //echo CHtml::ajaxlink('Delete',array('employees/manage','id'=>$list_1->id),array('confirm'=>'Do you want to delete Employee ?')) 
		...
		echo CHtml::ajaxLink(Yii::t('employees','Delete'), array('deletes','id'=>$list_1->id), array('success'=>'rowdelete('.$i.')'),array('confirm'=>'Do you want to delete this employee ?'));
