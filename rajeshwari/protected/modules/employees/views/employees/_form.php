...
<div class="captionWrapper">
	<ul>
    	<li><h2  class="cur"><?php echo Yii::t('employees','Employee Details'); ?></h2></li>
        <li><h2><?php echo Yii::t('employees','Employee Contact Details'); ?></h2></li>       
    </ul>
</div>
<?php $form=$this->beginWidget('CActiveForm', array(
    ...
    <div class="errorSummary"><?php echo Yii::t('employees','Input Error'); ?><br />
    <span><?php echo Yii::t('employees','Please fix the following error(s).'); ?></span>
    </div>
...
<table width="93%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
   ...
   <tr>
    ...
    <td valign="bottom">&nbsp;</td>
    <td><?php echo $form->labelEx($model,'total_experience',array('style'=>'float:left')); ?>&nbsp;<span class="required">*</span></td>
  ...
  <tr>
    <td colspan="5" valign="top"><?php echo $form->textArea($model,'experience_detail',array('style'=>'width: 330px !important;', 'rows'=>6, 'cols'=>48)); ?>
...
<table width="93%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td width="25%"><?php echo $form->dropDownList($model,'marital_status',array('Single'=>'Single','Married'=>'Married','Divorced'=>'Divorced')); ?>
...
<div class="clear"></div>
	<div style="padding:0px 0 0 0px; text-align:left">
		<?php echo CHtml::submitButton($model->isNewRecord ? Yii::t('employees','Next Step »') : Yii::t('employees','Save'),array('class'=>'formbut')); ?>
	</div>
