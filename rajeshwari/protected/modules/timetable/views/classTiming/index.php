...
?><?php
 $this->breadcrumbs=array(
	 'Manage Class Timings'=>array('/timetable'),
);
?>
<?php  
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
   ...
   <!--     
    ...
    <ul>
    <li>
    <?php echo CHtml::link(Yii::t('timetable','<span>Time Table</span>'), array('/timetable/weekdays/timetable','id'=>$_REQUEST['id']),array('class'=>'addbttn last'));?>
    </li>
...
<div class="right" align="left">
           ...
           <?php echo CHtml::link(Yii::t('timetable','Create Class Timings'), array('#'),array('id'=>'add_class-timings','class'=>'cbut')) ?>
</div>
