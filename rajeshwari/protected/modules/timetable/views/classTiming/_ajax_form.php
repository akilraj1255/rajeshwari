...
<div id="class-timings_form_con" class="client-val-form">
    <?php if ($model->isNewRecord) : ?>    <h3 id="create_header"><?php echo Yii::t('timetable','Set New Class Timing');?></h3>
    <?php  elseif (!$model->isNewRecord):  ?>    <h3 id="update_header"><?php echo Yii::t('timetable','Update Class Timing');?> </h3>
    <?php   endif;  ?>
...
<?php   $formId='class-timings-form';
   ...
   ($model->isNewRecord)?CController::createUrl('classTiming/ajax_create')
    ...
    <div style="font-weight:bold">'.Yii::t('timetable','Please correct these errors:').'</div>
    ...
    <div class="row">
        ...
        <div class="row">
            <?php echo $form->labelEx($model,Yii::t('timetable','name')); ?>
        ...
        <div class="row">
            <?php echo $form->labelEx($model,Yii::t('timetable','start_time')); ?>
    ...
    'deselectButtonText'=> 'Deselect' 
        ...
        <div class="row">
            <?php echo $form->labelEx($model,Yii::t('timetable','end_time')); ?>
           <?php $this->widget('application.extensions.jui_timepicker.JTimePicker', array(
     'model'=>$model,
	 'attribute'=>'end_time',
  ...
  <tr>
    ...
    <td><?php echo $form->labelEx($model,Yii::t('timetable','is_break')); ?></td>
