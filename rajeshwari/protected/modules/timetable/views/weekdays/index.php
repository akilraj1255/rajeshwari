...
$this->breadcrumbs=array(
  ...
  <?php if(isset($_REQUEST['id']) and $_REQUEST['id']!=NULL and !isset($_REQUEST['type'])) {?>
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
   ...
   <?php $this->renderPartial('/default/left_side');?>
	...
	{
		 $this->renderPartial('/default/tab');
	}
	?>
    ...
    <ul>
    <li>
    <?php echo CHtml::link(Yii::t('timetable','<span>Time Table</span>'), array('weekdays/timetable','id'=>$_REQUEST['id']),array('class'=>'addbttn last'));?>
    </li>
...
<h3 style="border-bottom:none;">Week Days</h3></span>
<?php
	  ...
	  if($_REQUEST['id']!='NULL')
	  {
         ...
         <tr>
           <td width="4%"><?php
             ...
             <td width="85%" align="left"><?php echo Yii::t('timetable','Sunday');?></td>
             <td width="11%">
         ...
         <tr>
           <td><?php
             ...
             <td align="left"><?php echo Yii::t('timetable','Monday');?></td>
             <td></td>
         </tr>
         <tr>
         	<td>&nbsp;</td>
         ...
         <tr>
           <td><?php
			  ...
			  ?></td>
             <td align="left"><?php echo Yii::t('timetable','Tuesday');?></td>
             <td></td>
         </tr>
         <tr>
         	<td>&nbsp;</td>
           ...
           <td><?php
			 if($batch[3]['weekday']==4)
			  ...
			  echo $form->checkBox($model,'wednesday',array('value'=>'4','class'=>'styled'));
			   ?></td>
             <td align="left"><?php echo Yii::t('timetable','Wednesday');?></td>
             <td></td>
         </tr>
         <tr>
         	<td>&nbsp;</td>
         ...
         <tr>
           <td><?php
			  ...
			  echo $form->checkBox($model,'thursday',array('value'=>'5','class'=>'styled'));
			   ?></td>
             <td align="left"><?php echo Yii::t('timetable','Thursday');?></td>
             <td></td>
         </tr>
         <tr>
         	<td>&nbsp;</td>
         ...
         <tr>
           <td><?php
			  ...
			  echo $form->checkBox($model,'friday',array('value'=>'6','checked'=>'checked','class'=>'styled'));
			   ...
			   ?></td>
             <td align="left"><?php echo Yii::t('timetable','Friday');?></td>
             <td></td>
         </tr>
         <tr>
         	<td>&nbsp;</td>
         ...
         <tr>
           <td><?php
			  ...
			  echo $form->checkBox($model,'saturday',array('value'=>'7','class'=>'styled'));
				 ?></td>
             <td align="left"><?php echo Yii::t('timetable','Saturday');?></td>
             <td></td>
         </tr>
         </table>
         </div><br />
         ...
         <tr>
           <td width="4%"><?php
			  ...
			  echo $form->checkBox($model,'sunday',array('value'=>'1','checked'=>'checked','class'=>'styled'));
			   ...
			   echo $form->checkBox($model,'sunday',array('value'=>'1','class'=>'styled')); ?></td>
             <td width="85%"><?php echo Yii::t('timetable','Sunday');?><?php echo Yii::t('timetable','Sunday');?></td>
             <td width="11%">&nbsp;</td>
         </tr>
         <tr>
           <td><?php
			 if($batch[1]['weekday']==2)
			  ...
			  echo $form->checkBox($model,'monday',array('value'=>'2','class'=>'styled')); ?></td>
             <td><?php echo Yii::t('timetable','Monday');?></td>
             <td>&nbsp;</td>
         </tr>
         <tr>
           <td><?php
			  ...
			  echo $form->checkBox($model,'tuesday',array('value'=>'3','checked'=>'checked','class'=>'styled')); 
			   ...
			   echo $form->checkBox($model,'tuesday',array('value'=>'3','class'=>'styled')); 
			  ?></td>
             <td><?php echo Yii::t('timetable','Tuesday');?></td>
             <td>&nbsp;</td>
         </tr>
         <tr>
           <td><?php
			 if($batch[3]['weekday']==4)
			  ...
			  echo $form->checkBox($model,'wednesday',array('value'=>'4','class'=>'styled'));
			   ?></td>
             <td><?php echo Yii::t('timetable','Wednesday');?></td>
             <td>&nbsp;</td>
         </tr>
         <tr>
           <td><?php
			  ...
			  echo $form->checkBox($model,'thursday',array('value'=>'5','class'=>'styled'));
			   ?></td>
             <td><?php echo Yii::t('timetable','Thursday');?></td>
             <td>&nbsp;</td>
         </tr>
         <tr>
           <td><?php
			  ...
			  echo $form->checkBox($model,'friday',array('value'=>'6','checked'=>'checked','class'=>'styled'));
			   ...
			   echo $form->checkBox($model,'friday',array('value'=>'6','class'=>'styled'));
			   ?></td>
             <td><?php echo Yii::t('timetable','Friday');?></td>
             <td>&nbsp;</td>
         </tr>
         <tr>
           <td><?php
			  ...
			  echo $form->checkBox($model,'saturday',array('value'=>'7','class'=>'styled'));
				 ?></td>
             <td><?php echo Yii::t('timetable','Saturday');?></td>
             <td>&nbsp;</td>
         </tr>
         </table>
         ...
         <tr>
           <td width="4%"><?php
			  ...
			  echo $form->checkBox($model,'sunday',array('value'=>'1','checked'=>'checked','class'=>'styled'));
			   ...
			   echo $form->checkBox($model,'sunday',array('value'=>'1','class'=>'styled')); ?></td>
             <td width="85%"><?php echo Yii::t('timetable','Sunday');?></td>
             <td width="11%">&nbsp;</td>
         </tr>
         <tr>
         	<td>&nbsp;</td>
