...
<tr>
	...
	array('prompt'=>'Select Subject','style'=>'width:200px;','ajax' => array('type'=>'POST','url'=>CController::createUrl('TimetableEntries/dynamiccities'),'update'=>'#emp_id'))); ?>
  ...
  <td><?php echo $form->dropDownList($model,'employee_id', array(),array('id'=>'emp_id','prompt'=>'Select Employee','style'=>'width:200px;')); ?></td>
