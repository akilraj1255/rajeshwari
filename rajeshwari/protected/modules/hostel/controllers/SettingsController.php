...
class SettingsController extends RController
{
	...
	public function actionRemind()
	{
       ...
       if(mail($to, $subject, $message, $headers))// Send mail if message is set
		{ 
			Yii::app()->user->setFlash('notification','Mail send Successfully!');
		}
		else
		{
		
		Yii::app()->user->setFlash('notification','Mail sending failed!');
