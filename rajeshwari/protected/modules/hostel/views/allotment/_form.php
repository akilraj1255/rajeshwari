...
<div class="formConInner">
  ...
  <tr>
    <td><?php echo $form->labelEx($model,Yii::t('hostel','Bed no')); ?></td>
    <td>&nbsp;</td>
  ...
  <tr>
	...
	<div class="row buttons">
		<?php echo CHtml::submitButton($model->isNewRecord ? Yii::t('hostel','Allot') : Yii::t('hostel','Save'),array('class'=>'formbut')); ?>
	</div>
</div>
</div>
<?php $this->endWidget(); ?>
