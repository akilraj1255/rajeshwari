...
<table width="80%" border="0" cellspacing="0" cellpadding="0">
 <tr>
  ...
  <tr>
   ...
   <tr>
    <td><?php echo $form->labelEx($model,Yii::t('hostel','room_no')); ?></td>
    <td>&nbsp;</td>
    <td><?php echo $form->textField($model,'room_no',array('size'=>20,'value'=>$student_details->room_no)); ?>
  ...
  <tr>
    ...
    <td>&nbsp;</td>
	 ...
	 <tr>
    <td><?php echo $form->labelEx($model,Yii::t('hostel','Admission date')); ?></td>
    <td>&nbsp;</td>
    <?php
...
<?php */?>
	...
	<div class="row buttons">
		<?php echo CHtml::submitButton($model->isNewRecord ? Yii::t('hostel','Vacate') : Yii::t('hostel','Save'),array('class'=>'formbut')); ?>
	</div>
    </div>
</div>
<?php $this->endWidget(); ?>
