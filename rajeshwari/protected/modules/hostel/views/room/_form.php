...
<div class="formConInner"> 
  ...
  <tr>
    <td><?php echo $form->labelEx($model,Yii::t('hostel','Room No')); ?></td>
    <th>&nbsp;</th>
    <td><?php echo $form->textField($model,'room_no[]',array('size'=>20)); ?>
		<?php echo $form->error($model,'room_no'); ?></td>
  
    <td><?php echo $form->labelEx($model,Yii::t('hostel','no_of_bed')); ?></td>
    <td>&nbsp;</td>
...
<tr>
    ...
    <td width="6%">&nbsp;</td>
    <td width="85%"><?php echo $form->textField($model,'floor',array('value'=>$_REQUEST['id'],'readonly'=>true)); ?>
