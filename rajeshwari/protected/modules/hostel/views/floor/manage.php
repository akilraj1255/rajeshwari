...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <ul>
    <li> <?php echo CHtml::link('<span>'.Yii::t('hostel','Enter Room Details').'</span>', array('/hostel/Floordetails/create'),array('class'=>'addbttn last ')); ?></li>
    </ul>
    </div>
		...
		foreach($hst as $hostel)
		{
			...
			?>
                <tr>
                    ...
                    <td align="center"><?php echo CHtml::link('Edit',array('/hostel/Hosteldetails/update','id'=>$hostel->id)).' | '.CHtml::link('Delete',array('/hostel/Hosteldetails/deleteall','id'=>$hostel->id),array('confirm'=>'Are you sure?'));?></td>
                </tr>
                <?php
