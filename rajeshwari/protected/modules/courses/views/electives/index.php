...
<?php
 $this->breadcrumbs=array(
	 Yii::t('Electives','Manage Electives')
);
?>
<?php  
...
<div > 
<h3><?php echo Yii::t('Electives','Electives'); ?></h3>

<div class="right" align="left">
               
            <?php echo CHtml::link(Yii::t('Electives','Create Elective Groups'), array('#'),array('id'=>'add_electivegroups','class'=>'cbut'));?>
            
            <?php echo CHtml::link(Yii::t('Electives','Create Electives'), array('#'),array('id'=>'add_electives','class'=>'cbut'));?>
            
            <?php echo CHtml::link(Yii::t('Electives','Manage Electivegroups'), array('/courses/electiveGroups','id'=>$_REQUEST['id']),array('class'=>'cbut'));?>
           
   </div>
<?php
//Strings for the delete confirmation dialog.
$del_con = Yii::t('admin_electives', 'Are you sure you want to delete this electives?');
$del_title=Yii::t('admin_electives', 'Delete Confirmation');
 $del=Yii::t('admin_electives', 'Delete');
 $cancel=Yii::t('admin_electives', 'Cancel');
   ?>
<?php
    ...
    array(
                   'class' => 'CButtonColumn',
                    'buttons' => array(
                                                     ...
                                                     'label' => Yii::t('admin_electives', 'Delete'), // text label of the button
                                                      ...
                                                      'options' => array("class" => "fan_del", 'title' => Yii::t('admin_electives', 'Delete')), // HTML options for the button   tag
                                                      ),
                                                     'electives_update' => array(
                                                     'label' => Yii::t('admin_electives', 'Update'), // text label of the button
                                                     'url' => '$data->id', // a PHP expression for generating the URL of the button
                                                     ...
                                                     'options' => array("class" => "fan_update", 'title' => Yii::t('admin_electives', 'Update')), // HTML options for the    button tag
                                                        ),
                                                     'electives_view' => array(
                                                      'label' => Yii::t('admin_electives', 'View'), // text label of the button
                                                      'url' => '$data->id', // a PHP expression for generating the URL of the button
                                                      ...
                                                      'options' => array("class" => "fan_view", 'title' => Yii::t('admin_electives', 'View')), // HTML options for the    button tag
                                                        )
                                                    ),
                   'template' => '{electives_view}{electives_update}{electives_delete}',
            ),
    ),
