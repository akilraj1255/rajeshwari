...
<p class="note"><?php echo Yii::t('timetable','Fields with');?><span class="required">*</span><?php echo Yii::t('timetable',' are required.');?></p>

<div class="errorSummary" id="error_employee" style="display:none; width:360px; height:20px; padding-top:10px;">
	<?php echo Yii::t('timetable','Please fill all the fields!');?>
</div> <br />
...
<tr>
	...
	array('prompt'=>Yii::t('timetable','Select Subject'),'style'=>'width:200px;','ajax' => array('type'=>'POST','url'=>CController::createUrl('TimetableEntries/dynamiccities'),'update'=>'#TimetableEntries_employee_id'))); ?>
		</td>
  </tr>
  <tr>
  	<td colspan="2">&nbsp;</td>
