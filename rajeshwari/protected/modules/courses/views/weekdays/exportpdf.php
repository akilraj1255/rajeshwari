...
<div class="atnd_Con" style="padding-left:20px; padding-top:30px;">
	...
	?> 
                ...
                <tr>
                    ...
                    <td align="center" valign="middle" class="first" style="width:300px;">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                <td class="listbxtop_hdng first" style="text-align:left; font-size:14px; padding-left:10px;">
                                    <?php echo Yii::t('timetable','Phone: ').$college[2]->config_value; ?>
                                </td>
                            </tr>
                        </table>
                    </td>
        ...
        <!-- End Header --> 
        <br /><br />
    <span align="left"><h4><?php echo Yii::t('timetable','CLASS TIME TABLE');?></h4></span>
    <!-- Course details -->
    <div style="border:#CCC 1px; width:700px; padding:10px 10px; background:#E1EAEF;">
        <table style="font-size:14px;">
            ...
            ?>
            <tr>
                <td style="width:100px;"><b><?php echo Yii::t('timetable','Course'); ?></b></td>
                <td style="width:10px;">:</td>
                <td style="width:250px;"><?php echo $course_name->course_name; ?></td>
            
                <td><b><?php echo Yii::t('timetable','Batch'); ?></b></td>
                <td style="width:10px;">:</td>
                <td><?php echo $batch->name; ?></td>
            </tr>
            <tr>
                <td><b><?php echo Yii::t('timetable','Class Teacher'); ?></b></td>
                <td>:</td>
                <td>
					<?php 
				...
				?>
                <td><b><?php echo Yii::t('timetable','Total students'); ?></b></td>
                <td>:</td>
		...
		<table  align="left" width="600" id="table" cellspacing="0" cellpadding="0" class="timetable" >
			<tr>
			  ...
			  <?php 
					...
					<?php echo '<td style="font-size:11px;background:#E1EAEF;">'.$timing_1->start_time .' - <br>'.$timing_1->end_time.'</td>';?>
				<?php 	}
			   ?>
			</tr> <!-- timetable_tr -->
		...
		$set =  TimetableEntries::model()->findByAttributes(array('batch_id'=>$_REQUEST['id'],'weekday_id'=>$weekdays[0]['weekday'],'class_timing_id'=>$timing[$i]['id'])); 			
						...
						else
						{
							...
							if($time_sub!=NULL){echo $time_sub->name.'<br>';
								...
								if($time_emp!=NULL){echo '<span style="font-size:9px;">(' .$time_emp->first_name.' '.$time_emp->last_name.')</span>';}
							}
						}
				 ?>
   ...
   <div style="border:#CCC 1px; width:700px; padding:10px 10px; background:#E1EAEF;">
        <?php echo '<i>'.Yii::t('timetable','No Class Timings is set for this batch').'</i>'; ?>
   </div>      
