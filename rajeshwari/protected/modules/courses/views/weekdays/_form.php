...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<p class="note"><?php echo Yii::t('weekdays','Fields with'); ?> <span class="required">*</span> <?php echo Yii::t('weekdays','are required.'); ?></p>
...
echo CHtml::activeDropDownList($model,'batch_id',$data1,array('prompt'=>'Select','id'=>'batch_id')); ?>
	...
	<div class="row buttons">
		<?php echo CHtml::submitButton($model->isNewRecord ? Yii::t('weekdays','Create') : Yii::t('weekdays','Save')); ?>
	</div>
