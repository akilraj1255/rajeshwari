                                            ...
                                            <div class="timetable" style="margin-top:10px;">
                                                <table border="0" align="center" width="100%" id="table" cellspacing="0">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                        	<td class="td">
                                                            	<div class="name"><?php echo Yii::t('weekdays','SUN');?></div>
															</td>
                                                        	<td class="td-blank"></td>
															<?php
                                                            for($i=0;$i<$count_timing;$i++)
														...
														<tr>
															<td class="td">
                                                            	<div class="name"><?php echo Yii::t('weekdays','MON');?></div>
                                                            </td>
															<td class="td-blank"></td>
															<?php
                                                            for($i=0;$i<$count_timing;$i++)
                                                            {
																...
																if(count($set)==0)
																{
																	...
																	if($is_break==NULL)
																	{	
																		echo CHtml::ajaxLink(Yii::t('weekdays','Assign'),$this->createUrl('TimetableEntries/settime'),array('onclick'=>'$("#jobDialog'.$timing[$i]['id'].$weekdays[1]['weekday'].'").dialog("open"); return false;',															'update'=>'#jobDialog'.$timing[$i]['id'].$weekdays[1]['weekday'],'type' =>'GET','data'=>array('batch_id'=>$_REQUEST['id'],'weekday_id'=>$weekdays[1]['weekday'],'class_timing_id'=>$timing[$i]['id']),'dataType'=>'text',),array('id'=>'showJobDialog'.$timing[$i]['id'].$weekdays[1]['weekday'])) ;
																	}
																	else
																	{
																		echo Yii::t('weekdays','Break');
														...
														<tr>
                                                            ...
                                                            for($i=0;$i<$count_timing;$i++)
                                                            {
																...
																if(count($set)==0)
																{
																	...
																	if($is_break==NULL)
																	{	
																		echo CHtml::ajaxLink(Yii::t('weekdays','Assign'),$this->createUrl('TimetableEntries/settime'),array('onclick'=>'$("#jobDialog'.$timing[$i]['id'].$weekdays[3]['weekday'].'").dialog("open"); return false;','update'=>'#jobDialog'.$timing[$i]['id'].$weekdays[3]['weekday'],'type' =>'GET','data'=>array('batch_id'=>$_REQUEST['id'],'weekday_id'=>$weekdays[3]['weekday'],'class_timing_id'=>$timing[$i]['id']),'dataType'=>'text',),array('id'=>'showJobDialog'.$timing[$i]['id'].$weekdays[3]['weekday'])) ;
																	}
																	else
																	{
																		echo Yii::t('weekdays','Break');
														...
														<tr>
                                                            ...
                                                            for($i=0;$i<$count_timing;$i++)
                                                            {
																...
																{	
																	...
																	if($is_break==NULL)
																	{	
																		echo CHtml::ajaxLink(Yii::t('weekdays','Assign'),$this->createUrl('TimetableEntries/settime'),array('onclick'=>'$("#jobDialog'.$timing[$i]['id'].$weekdays[4]['weekday'].'").dialog("open"); return false;','update'=>'#jobDialog'.$timing[$i]['id'].$weekdays[4]['weekday'],'type' =>'GET','data'=>array('batch_id'=>$_REQUEST['id'],'weekday_id'=>$weekdays[4]['weekday'],'class_timing_id'=>$timing[$i]['id']),'dataType'=>'text',),array('id'=>'showJobDialog'.$timing[$i]['id'].$weekdays[4]['weekday'])) ;
																	}
																	else
																	{
																		echo Yii::t('weekdays','Break');
														...
														<tr>
                                                            ...
                                                            for($i=0;$i<$count_timing;$i++)
                                                            {
																...
																if(count($set)==0)
																{
																	...
																	if($is_break==NULL)
																	{	
																		echo CHtml::ajaxLink(Yii::t('weekdays','Assign'),$this->createUrl('TimetableEntries/settime'),array('onclick'=>'$("#jobDialog'.$timing[$i]['id'].$weekdays[5]['weekday'].'").dialog("open"); return false;','update'=>'#jobDialog'.$timing[$i]['id'].$weekdays[5]['weekday'],'type' =>'GET','data'=>array('batch_id'=>$_REQUEST['id'],'weekday_id'=>$weekdays[5]['weekday'],'class_timing_id'=>$timing[$i]['id']),'dataType'=>'text',),array('id'=>'showJobDialog'.$timing[$i]['id'].$weekdays[5]['weekday'])) ;
																	}
																	else
																	{
																		echo Yii::t('weekdays','Break');
										...
										?>
											 ...
											 <div><br />
												<div class="a_feed_innercntnt" style="text-align:center; padding:10px; border:none;">
													<div></div>
													<h1><strong><?php echo '<i>'.Yii::t('weekdays','No Class Timings are set!').'</i>'; ?></strong></h1>
												</div>
											</div>
										<?php                                            
                                        }?>
