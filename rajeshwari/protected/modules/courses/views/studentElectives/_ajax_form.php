...
<div id="student-electives_form_con" class="client-val-form">
    <?php if ($model->isNewRecord) : ?>    <h3 id="create_header"><?php echo Yii::t('Electives','Create New StudentElectives'); ?></h3>
    <?php  elseif (!$model->isNewRecord):  ?>    <h3 id="update_header"><?php echo Yii::t('Electives','Update StudentElectives').$model->id;  ?>  </h3>
    <?php   endif;  ?>
    <?php      $val_error_msg = Yii::t('Electives','Error.StudentElectives was not saved.');
    $val_success_message = ($model->isNewRecord) ?
            Yii::t('Electives','StudentElectives was created successfuly.') :
            Yii::t('Electives','StudentElectives  was updated successfuly.');
  ?>
