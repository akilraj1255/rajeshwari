...
<div id="subjects_form_con" class="client-val-form" style="width:350px">
    ...
    <?php   endif;  ?>
    <?php      $val_error_msg = Yii::t('Subjects','Error.Subjects was not saved.');
    $val_success_message = ($model->isNewRecord) ?
            Yii::t('Subjects','Subject was added successfuly.') :
            Yii::t('Subjects','Subject  was updated successfuly.');
  ?>
...
<?php   $formId='subjects-form';
   ...
   ($model->isNewRecord)?CController::createUrl('subject/ajax_create')
	...
	?>
        <div class="row">
			<?php echo $form->labelEx($model,'batch_id', array('style'=>'color:#000000')); ?>
            <?php 
			 $criteria  = new CDbCriteria;
		     $criteria ->compare('is_deleted',0); 
 ...
 <div class="row">
  ...
  <div class="row">
    ...
    <div class="row buttons" style="width:30%">
        <?php   echo CHtml::submitButton($model->isNewRecord ? Yii::t('Subjects','Submit') : Yii::t('Subjects','Save'),array('class' =>
        'formbut')); ?>    </div>
