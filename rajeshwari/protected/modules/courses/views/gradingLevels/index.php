...
<?php
 $this->breadcrumbs=array(
	 Yii::t('examination','Manage Grading Levels')
);
?>
<?php  
...
<div  style="position:relative">
    ...
    <ul>
    <li>
    <?php echo CHtml::link('<span>'.Yii::t('examination','Assessments').'</span>', array('/courses/exam','id'=>$_REQUEST['id']),array('class'=>'addbttn last'));?>
    </li>
    </ul>
    <div class="clear"></div>
    </div>
...
<div class="right" align="left">
            ...
            <?php echo CHtml::link(Yii::t('examination','Create Grading Levels'), array('#'),array('id'=>'add_grading-levels','class'=>'cbut'));?>
            <?php echo CHtml::link(Yii::t('examination','Set Default Grading Levels'), array('gradingLevels/default','id'=>$_REQUEST['id']),array('class'=>'cbut','confirm'=>Yii::t('examination','Are You Sure? All custom settings will be deleted.')));?>
   </div><div id="success_flash" align="center" style=" color:#F00; display:none;"><h4><?php echo Yii::t('examination','Selected gradelevel Deleted Successfully!');?></h4>
