...
<div id="grading-levels_form_con" class="client-val-form">
    <?php if ($model->isNewRecord) : ?>    <h3 id="create_header"><?php echo Yii::t('examination','Create New GradingLevels');?></h3>
    <?php  elseif (!$model->isNewRecord):  ?>    <h3 id="update_header"><?php echo Yii::t('examination','Update GradingLevels');?> </h3>
       <?php   endif;  ?>
  <link rel="stylesheet" type="text/css" href="<?php echo Yii::app()->request->baseUrl; ?>/css/ui-style.css" />
    <?php      $val_error_msg = Yii::t('examination','Error.GradingLevels was not saved.');
    $val_success_message = ($model->isNewRecord) ?
            Yii::t('examination','GradingLevels was created successfuly.') :
            Yii::t('examination','GradingLevels  was updated successfuly.');
...
<?php   $formId='grading-levels-form';
   ...
   ($model->isNewRecord)?CController::createUrl('gradingLevels/ajax_create')
    ...
    <div class="row">
        ...
        <div class="row">
            <?php echo $form->labelEx($model,Yii::t('examination','min_score'),array('style'=>'color:#000000')); ?>
