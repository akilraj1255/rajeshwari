    ...
    <div class="setbx_con">
    	...
    	<div class="setbx_bot" >
    		<ul>
    			...
    			<li>
                <?php echo CHtml::link(Yii::t('Batch','Promote Batch').'<span>'.Yii::t('Batch','Admins').' &amp; '.Yii::t('Batch','Class Teachers').'</span>', array('batches/promote','id'=>$_REQUEST['id']),array('id'=>'add_exam-groups','class'=>'icon3')) ?></li>
    ...
    <div class="clear"></div>
    	...
    	<div class="setbx_bot">
   			<ul>
    			...
    			<li><?php echo CHtml::link(Yii::t('Batch','Add Subject to Batch').'<span>'.Yii::t('Batch','Admins').' &amp; '.Yii::t('Batch','Class Teachers').'</span>', array('/courses/subject','id'=>$_REQUEST['id']),array('id'=>'add_exam-groups','class'=>'icon6')) ?></li>
    	...
    	<div class="setbx_bot">
    		<ul>
    			<li>
                <?php echo CHtml::link(Yii::t('Batch','New Examination').'<span>'.Yii::t('Batch','Admins').' &amp; '.Yii::t('Batch','Class Teachers').'</span>', array('/courses/exam','id'=>$_REQUEST['id']),array('id'=>'add_exam-groups','class'=>'icon40')) ?>
                
                </li>
    			<li><?php echo CHtml::link(Yii::t('Batch','New Grading Level').'<span>'.Yii::t('Batch','Timetable').' &amp; '.Yii::t('Batch','Attendance').'</span>', array('/courses/gradingLevels','id'=>$_REQUEST['id']),array('class'=>'icon9'));?></li>
    			<li><?php echo CHtml::link(Yii::t('Batch','Set Default Grading Levels').'<span>'.Yii::t('Batch','Admins').' &amp; '.Yii::t('Batch','Class Teachers').'</span>', array('/courses/gradingLevels/default','id'=>$_REQUEST['id']),array('class'=>'icon10','confirm'=>Yii::t('Batch','Are You Sure? All custom settings will be deleted.')));?></li>
                <li><?php echo CHtml::link(Yii::t('Batch','Manage Exam Score').'<span>'.Yii::t('Batch','Admins').' &amp; '.Yii::t('Batch','Class Teachers').'</span>', array('/courses/exam','id'=>$_REQUEST['id']),array('id'=>'add_exam-groups','class'=>'icon11')) ?></li>
    	...
    	<div class="setbx_bot">
    		<ul>
    			<li>
                <?php echo CHtml::link(Yii::t('Batch','Set Week Days').'<span>'.Yii::t('Batch','Timetable').' &amp; '.Yii::t('Batch','Attendance').'</span>', array('/courses/weekdays','id'=>$_REQUEST['id']),array('class'=>'icon13'));?>
                </li>
    			<li>
                <?php echo CHtml::link(Yii::t('Batch','Set Class Timings').'<span>'.Yii::t('Batch','ClassTimings').' &amp; '.Yii::t('Batch','TimeTable').'</span>', array('/courses/classTiming','id'=>$_REQUEST['id']),array('class'=>'icon14'));?>
    			<li>
