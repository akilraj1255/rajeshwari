...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
   ...
   <td><?php echo $form->labelEx($model,'Teacher'); ?></td>
	...
	?>
    <td><?php echo $form->dropDownList($model,'employee_id',CHtml::listData(Employees::model()->findAll($criteria),'id','concatened'),array('empty' => Yii::t('Batch','Select Class Teacher'))); ?>
  ...
  <tr>
    ...
    <td><?php //echo CHtml::submitButton($model->isNewRecord ? 'Create' : 'Save'); ?>
        <?php	
		echo CHtml::ajaxSubmitButton(Yii::t('Batch','Save'),CHtml::normalizeUrl(array('Batches/Addupdate&val1='.$batch_id,'render'=>false)),
		array('success'=>'js: function(data) {
									 $("#success_msg").html("'.Yii::t('Batch','Batch updated successfully!').'");
									 setTimeout(function() {
