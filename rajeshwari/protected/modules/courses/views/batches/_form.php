...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<p style="padding-left:20px;"><?php echo Yii::t('Batch','Fields with');?><span class="required">*</span><?php echo Yii::t('Batch','are required.');?></p>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="45%"><?php echo $form->labelEx($model,'name'); ?></td>
    <td width="5%">&nbsp;</td>
  ...
  <tr>
   ...
   <td><?php echo $form->labelEx($model,'Teacher'); ?></td>
	...
	?>
    <td><div><?php echo $form->dropDownList($model,'employee_id',CHtml::listData(Employees::model()->findAll($criteria),'id','concatened'),array('empty' => Yii::t('Batch','Select Class Teacher'))); ?>
  ...
  <tr>
    ...
    <td><?php //echo CHtml::submitButton($model->isNewRecord ? 'Create' : 'Save'); ?>
        ...
        <?php	echo CHtml::ajaxSubmitButton(Yii::t('Batch','Save'),CHtml::normalizeUrl(array('batches/create','render'=>false)),array('success'=>'js: function(data) { $("#jobDialog").dialog("close"); window.location.reload();
