...
<div id="elective-groups_form_con" class="client-val-form" style="width:350px">
    <?php if ($model->isNewRecord) : ?>    <h3 id="create_header"><?php echo Yii::t('Electives','Create Nwwwew Elective Groups'); ?></h3>
    <?php  elseif (!$model->isNewRecord):  ?>    <h3 id="update_header"><?php echo Yii::t('Electives','Update Elective Group : '); ?> <?php  echo
        $model->name;  ?>  </h3>
    <?php   endif;  ?>
    <?php      $val_error_msg = Yii::t('Elective Groups','Error.Elective Groups was not saved.');
    $val_success_message = ($model->isNewRecord) ?
            Yii::t('Elective Groups','Electives was created successfuly.') :
            Yii::t('Elective Groups','Electives was updated successfuly.');
  ?>
...
<?php   $formId='elective-groups-form';
   ...
   ($model->isNewRecord)?CController::createUrl('electiveGroups/ajax_create')
    ...
    <div style="font-weight:bold">'.Yii::t('Electives','Please correct these errors:').'</div>
    ...
    <div class="row">
        ...
        <span style="margin-top:0px; position: relative; right:-3px; top:-23px;" id="success-ElectiveGroups_name"
...
<div class="row">
            ...
            <?php echo $form->textField($model,'code',array('size'=>60,'maxlength'=>15)); 
			 ...
			 ?>
        <span style="margin-top:0px; position: relative; right:-3px; top:-23px;" id="success-ElectiveGroups_code"
              class="hid input-notification-success  success png_bg right"></span>
        <div>
            <small></small>
        </div>
...
<div class="row">
 ...
 <?php if($model->batch_id==NULL)
   ...
   <div class="row buttons" style="width:40%">
        <?php   echo CHtml::submitButton($model->isNewRecord ? Yii::t('Electives','Sumbit') : Yii::t('Electives','Save'),array('class' =>
        'formbut')); ?>    </div>
