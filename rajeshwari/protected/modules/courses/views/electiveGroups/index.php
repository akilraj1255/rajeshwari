...
?><?php
 $this->breadcrumbs=array(
	Yii::t('Electives','Manage Elective Groups')
);
?>
<?php  
...
<div class="right" align="left">
            ...
            <?php echo CHtml::link(Yii::t('Electives','Create Elective Groups'), array('#'),array('id'=>'add_electives','class'=>'cbut'));?>
            
            <?php /*?><?php echo CHtml::link(Yii::t('Gradelevel','Create Electives'), array('#'),array('id'=>'add_electivesubjects','class'=>'cbut'));?><?php */?>
            
            <?php echo CHtml::link(Yii::t('Electives','Manage Electives'), array('/courses/electives','id'=>$_REQUEST['id']),array('class'=>'cbut'));?>
           
   </div>
<?php
//Strings for the delete confirmation dialog.
$del_con = Yii::t('admin_elective-groups', 'Are you sure you want to delete this elective-groups?');
$del_title=Yii::t('admin_elective-groups', 'Delete Confirmation');
 $del=Yii::t('admin_elective-groups', 'Delete');
 $cancel=Yii::t('admin_elective-groups', 'Cancel');
   ?>
<?php
    ...
    array(
                   'class' => 'CButtonColumn',
                    'buttons' => array(
                                                     ...
                                                     'label' => Yii::t('admin_elective-groups', 'Delete'), // text label of the button
                                                     ...
                                                     'label' => Yii::t('admin_elective-groups', 'Update'), // text label of the button
                                                     'url' => '$data->id', // a PHP expression for generating the URL of the button
                                                     ...
                                                     'elective-groups_view' => array(
                                                      'label' => Yii::t('admin_elective-groups', 'View'), // text label of the button
                                                      'url' => '$data->id', // a PHP expression for generating the URL of the button
