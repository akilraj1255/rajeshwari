...
<h1><?php echo Yii::t('examination','Create Exam Groups'); ?></h1>
...
echo '<strong>'.Yii::t('examgroups','Select Course').'</strong>';
...
echo CHtml::dropDownList('cid','',$data,array('onchange'=>'course()','id'=>'coursedrop','empty'=>Yii::t('examgroups','Select Course'),'options'=>array($sel=>array('selected'=>true)))); 
echo '<br>';
