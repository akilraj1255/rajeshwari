...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		...
		<?php echo $form->dropDownList($model,'exam_type',array('Marks'=>Yii::t('examination','Marks'),'Grades'=>Yii::t('examination','Grades'),'Marks And Grades'=>Yii::t('examination','Marks And Grades'))); ?>
