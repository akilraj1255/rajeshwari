	...
	<tr>
		...
		if($sub->elective_group_id!=0)
		{
			...
			if($studentelctive==NULL) 
			{
				...
				?>
      		<?php echo Yii::t('examination','<i><span style="color:#E26214;">Elective not assigned</span></i>  ').CHtml::link('Add now',array('/courses/batches/elective','id'=>$_REQUEST['id'])); ?>
           	 <?php
				}
		}?>
...
<?php if($i==1)
	...
	<div align="left">
		<?php if($i!=1) echo CHtml::submitButton($model->isNewRecord ? Yii::t('examination','Create') : Yii::t('examination','Save'),array('class'=>'formbut')); ?>
	</div>
