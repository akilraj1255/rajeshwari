<div class="formCon" style="width:60%">
    <div class="formConInner" >
        ...
        <table width="50%">
        	<tr>
            	<td><strong><?php echo Yii::t('examination','Examination:');?> </strong><?php echo ucfirst($exam_group->name); ?></td>
                <td><strong><?php echo Yii::t('examination','Subject:');?> </strong><?php echo ucfirst($exam->name); ?></td>
			</tr>
        </table>
    </div>
</div>
