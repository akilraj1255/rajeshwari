...
$this->breadcrumbs=array(
	Yii::t('examination','Exam')=>array('/courses'),
	$model->name,
);
?>
<?php  
...
<div class="c_subbutCon" align="right" style="width:100%">
    ...
    <ul>
    <li>
<?php echo CHtml::link('<span>'.Yii::t('examination','Create Exam').'</span>', array('#'),array('id'=>'add_exam-groups','class'=>'addbttn')) ?>
 </li>
 <li>
<?php echo CHtml::link('<span>'.Yii::t('examination','Grading Levels').'</span>', array('/courses/gradingLevels','id'=>$_REQUEST['id']),array('class'=>'addbttn last')) ?>
 </li>
    </ul>
...
<?php
    $this->widget('zii.widgets.grid.CGridView', array(
		...
		array(
            'name'=>'is_published',
            'value'=>'$data->is_published ? "'.Yii::t('examination','Yes').'" : "'.Yii::t('examination','No').'"'
        ),
		array(
            'name'=>'result_published',
            'value'=>'$data->result_published ? "'.Yii::t('examination','Yes').'" : "'.Yii::t('examination','No').'"'
        ),
			...
			array(
                   'class' => 'CButtonColumn',
                    'buttons' => array(
														...
														'add' => array(
                                                        'label' => Yii::t('examination','Manage This Exam'), // text label of the button
