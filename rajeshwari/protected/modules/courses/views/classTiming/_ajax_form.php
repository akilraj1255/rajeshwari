 ...
 * @ver 1.3
 -->
 <style type="text/css">
.input-notification-success{ position:relative;
	margin-top:-26px;}
...
<div id="class-timings_form_con" class="client-val-form">
    ...
    <?php   endif;  ?>
    <?php      $val_error_msg = Yii::t('Timing','Error.Class Timing was not saved.');
    $val_success_message = ($model->isNewRecord) ?
            Yii::t('Timing','Class Timing was set successfuly.') :
            Yii::t('Timing','Class Timing was updated successfuly.');
  ?>
...
<?php   $formId='class-timings-form';
  ...
  <tr>
    ...
    <div class="row buttons" style="width:30%;">
        <?php   echo CHtml::submitButton($model->isNewRecord ? Yii::t('Timing','Submit') : Yii::t('Timing','Save'),array('class'=>'formbut')); ?>    </div>
