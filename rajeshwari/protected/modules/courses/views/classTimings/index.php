...
<h3><?php echo Yii::t('Timing','View Class Timings');?></h3>
...
<?php
	...
	{
	echo CHtml::ajaxLink(Yii::t('Timing','Add'),$this->createUrl('ClassTimings/addnew'),array(
      ...
      <div class="tablelist">
        ...
        ),array('id'=>'showJobDialog12'.$_REQUEST['id'])).'&nbsp;|&nbsp;<a href="#">'.Yii::t('Timing','Delete').'</a></td>';  
            echo '</tr>';
          }
            ?>
