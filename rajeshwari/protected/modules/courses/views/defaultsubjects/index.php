...
$this->breadcrumbs=array(
	Yii::t('courses','Subject Names')=>array('/courses'),
...
<div style="padding:20px;">
 ...
 <div class="c_subbutCon" align="right" style="width:100%">
    ...
    <li>
    <?php echo CHtml::link(Yii::t('courses','Subjects'), array('/courses/subject','id'=>$_REQUEST['id']),array('class'=>'addbttn last')) ?>
...
<div class="right" align="right">
            ...
            <?php echo CHtml::link(Yii::t('courses','Add New Subject'), array('#'),array('id'=>'add_subject-name','class'=>'cbut')) ?>
