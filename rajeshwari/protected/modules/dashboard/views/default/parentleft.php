  <div id="parent_leftSect">
           ...
           <?php
			...
			{
				echo CHtml::link('Events',array('/dashboard/default/events'),array('class'=>'events_active'));
			}
			else
			{
				echo CHtml::link('Events',array('/dashboard/default/events'),array('class'=>'events'));
			}
            ?>
           </li>
             <li>
