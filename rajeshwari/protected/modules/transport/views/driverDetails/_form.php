...
<div class="formConInner">
    <table width="80%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td>
                <?php echo $form->labelEx($model,Yii::t('transport','first_name')); ?>
            </td>
            <td>&nbsp;
            </td>
            <td>
        ...
        <tr>
            <td>
                <?php echo $form->labelEx($model,Yii::t('transport','last_name')); ?>
            </td>
            <td>&nbsp;
            </td>
            <td>
        ...
        <tr>
            <td>
                <?php echo $form->labelEx($model,Yii::t('transport','dob')); ?>
            </td>
            <td>&nbsp;
            </td>
            <td>
        ...
        <tr>
         ...
         <tr>
            <td>
                <?php echo $form->labelEx($model,Yii::t('transport','age')); ?>
            </td>
            <td>&nbsp;
            </td>
            <td>
        ...
        <tr>
         ...
         <tr>
            <td>
                <?php echo $form->labelEx($model,Yii::t('transport','license_no')); ?>
            </td>
            <td>&nbsp;
            </td>
            <td>
        ...
        <tr>
         ...
         <tr>
            <td>
                <?php echo $form->labelEx($model,Yii::t('transport','expiry_date')); ?>
            </td>
            <td>&nbsp;
            </td>
            <td>
