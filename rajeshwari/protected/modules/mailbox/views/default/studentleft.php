  <div id="parent_leftSect">
          ...
          <?php /*?> <li>
           <?php
			...
			{
				echo CHtml::link(Yii::t('studentportal','Course'),array('/studentportal/default/course'),array('class'=>'course_active'));
			}
			else
			{
				echo CHtml::link(Yii::t('studentportal','Course'),array('/studentportal/default/course'),array('class'=>'course'));
			}
		   ?>
           </li>   <?php */?>
             <li>
           ...
           <?php
			...
			{
				echo CHtml::link(Yii::t('studentportal','Hostel'),array('/hostel'),array('class'=>'hostel_active'));
			}
			else
			{
				echo CHtml::link(Yii::t('studentportal','Hostel'),array('/hostel'),array('class'=>'hostel'));
			}
		   ?>
           </li>
           <li>
