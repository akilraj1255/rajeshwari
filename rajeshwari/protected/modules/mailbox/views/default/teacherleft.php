  <div id="parent_leftSect">
			...
			{
				echo CHtml::link(Yii::t('teachersportal','Leaves'),array('/teachersportal/leaves/create'),array('class'=>'news_active'));
			}
			else
			{
				echo CHtml::link(Yii::t('teachersportal','Leaves'),array('/teachersportal/leaves/create'),array('class'=>'news'));
			}
			?>
           </li>
            <li>
			...
			{
				echo CHtml::link(Yii::t('teachersportal','Payslip'),array('/teachersportal/default/payslip'),array('class'=>'news_active'));
			}
			else
			{
				echo CHtml::link(Yii::t('teachersportal','Payslip'),array('/teachersportal/default/payslip'),array('class'=>'news'));
			}
			?>
           </li><?php */?>
