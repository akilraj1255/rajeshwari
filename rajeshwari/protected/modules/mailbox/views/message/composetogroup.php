...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <div class="mail_head"><?php echo Yii::t('message','New Message');?><span><?php echo Yii::t('message','Compose new message here.');?></span></div>
      <div >
<?php
...
'enableAjaxValidation'=>true,
	...
	<div class="formCon" style="margin:10px; padding:10px; width:710px;">	
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td><?php echo '<strong>'.CHtml::activeLabelEx($conv,Yii::t('message','To')).'</strong>'; ?></td>
    <td>
                <?php
...
?></td>
  ...
  <tr>
    <td><?php echo '<strong>'.CHtml::activeLabelEx($conv,Yii::t('message','Subject'),array('class'=>'mailbox-label')).'</strong>'; ?></td>
