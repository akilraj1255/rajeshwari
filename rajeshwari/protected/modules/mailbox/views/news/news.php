...
$this->breadcrumbs=array(
  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
     ...
     <div class="mail_head"><?php echo Yii::t('message','Site News');?><span><?php echo Yii::t('message','Latest news listed here');?></span></div>
    <?php 
...
<form id="message-list-form" action="<?php echo $this->createUrl($this->getId().'/'.$this->getAction()->getId()); ?>" method="post">
	...
	if($this->module->isAdmin() && $dataProvider->getItemCount() > 1) : ?>
		<div class="btn-group mailbox-checkall-buttons">
            <input type="checkbox"  name="ch1" class="chkbox checkall" /> <?php echo Yii::t('message','Select All');?> 
...
<?php
	...
	echo '<div class="mailbox-empty">'.Yii::t('message','No news to report.').'</div>';
}
