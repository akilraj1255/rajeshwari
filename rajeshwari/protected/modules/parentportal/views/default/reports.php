            ...
            <div class="profile_top">
                ...
                <?php
				 if($student->photo_file_name){ 
   				 echo '<img  src="'.$this->createUrl('DisplaySavedImage&id='.$student->primaryKey).'" alt="'.$student->photo_file_name.'" width="100" height="64" />';
	 }else{
