      ...
      <div id="parent_Sect">
        ...
        <div id="parent_rightSect">
        	<div class="parentright_innercon">
             <h1><?php echo Yii::t('parentportal','New Message'); ?></h1>
                  ...
                  <div class="form">
                        ...
                        <div class="row">
                         <?php echo $form->labelEx($message,Yii::t('message','receiver_id')); ?>
