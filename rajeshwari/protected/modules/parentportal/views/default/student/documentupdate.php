    ...
    <div id="parent_rightSect">
        <div class="parentright_innercon">
        	<div class="profile_top">
                ...
                <h2><?php echo ucfirst($student->first_name).' '.ucfirst($student->last_name);?></h2>
                <ul>
            ...
            <div class="document_box">
            	...
            	<div class="form">
                	<div class="edit_bttns" style="top:175px; right:15px;">
                        <ul>
                            <li>
                                <?php echo CHtml::link(Yii::t('students','<span>Student Profile</span>'), array('studentprofile'),array('class'=>' edit ')); ?>
                            </li>
                        </ul>
					...
					<?php $form=$this->beginWidget('CActiveForm', array(
                        ...
                        <p class="note" style="float:left">Fields with <span class="required">*</span> are required. Upload a file if it is removed.</p>
                        ...
                        <div class="formCon" style="clear:left;">
                            <div class="formConInner" id="innerDiv">
                                <table width="80%" border="0" cellspacing="0" cellpadding="0" id="documentTable">
                                    <tr>
                                        <td width="10%"><?php echo $form->labelEx($model,Yii::t('students','Document Name'),array('style'=>'float:left;')); ?><span class="required">&nbsp;*</span></td>
                                        <td>&nbsp;</td>
                                    ...
                                    <tr>
                                        ...
                                        <td id="existing_file">
                                            ...
                                            <ul class="tt-wrapper">
                                                <li>
                                                    <?php echo CHtml::link('<span>View</span>', array('download','id'=>$model->id,'student_id'=>$model->student_id),array('class'=>'tt-download')); ?>
                                                </li>
                                                <li>
                                                    <?php echo CHtml::link('<span>Remove</span>', array('#'),array('class'=>'tt-delete','onclick'=>'return removeFile();')); ?>
                                                </li>
                                            </ul>
                                            <?php
                                            }
                        ...
                        <div class="row buttons">
                            ...
                            <?php echo CHtml::submitButton('Update',array('class'=>'formbut','submit'=>'documentupdate')); ?>
                        </div>
