      ...
      <div id="parent_Sect">
        ...
        <div id="parent_rightSect">
        	<div class="parentright_innercon">
             <h1><?php echo Yii::t('parentportal','View Message'); ?></h1>
                ...
                <div class="inbox_filter">
                	<ul>
                        ...
                        <?php echo CHtml::link(Yii::t('message','Compose Mail'),array('newmessage'));?>
                       </li>
				...
				if($msg!=NULL)
				{
					 $settings=UserSettings::model()->findByAttributes(array('user_id'=>Yii::app()->user->id));
						...
						?>
                         ...
                         From:<?php echo $user->lastname.' '.$user->firstname;?>&nbsp;&nbsp;On &nbsp;<?php echo '<span>'.$date1.' '.$time.'</span>';?>
                         <br />
                         ...
                         <?php echo $msg->body;?>
                            ...
                            <br /><br />
                         <h3><?php echo Yii::t('message','Reply') ?></h3>
                         <div class="form">
