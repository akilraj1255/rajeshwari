...
<script>
	...
	max: 100,
	titleFontColor :"#464646",
	title: "Annual Exam Average Marks",
	label: "marks"
	});
        ...
        <td valign="top">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <div style="font-size:13px; padding:5px 0px"><strong>Recent Exams</strong></div>
                    <div class="pdtab_Con">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr class="pdtab-h">
                                <td align="center">
                                    <?php echo Yii::t('examination','Date');?>
                                </td>
                                <td align="center">
                                    <?php echo Yii::t('examination','Assessment');?>
                                </td>
                                <td align="center">
                                	<?php echo Yii::t('examination','Class Teacher');?>
                                </td>
                                <td align="center">
                                	<?php echo Yii::t('examination','Batch');?>
                                </td>
                                <td align="center">
                                	<?php echo Yii::t('examination','Average');?>
                                </td>
                            </tr>
                                    	...
                                    	<tr>
                                            ...
                                            <td align="center">
												...
												if($recent_exams!=NULL)
												{
													...
													{
														echo Yii::t('examination','No students');
														//echo 'No students';
													}
												}
												else
												{
													echo Yii::t('examination','No exams created');
								...
								else
								{
									...
									echo '<td align="center" colspan="5"><strong>'.Yii::t('examination','No Recent Exams!').'</td>';
								}
