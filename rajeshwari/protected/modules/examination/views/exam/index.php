...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
   ...
   <?php $this->renderPartial('/default/left_side');?>
    ...
    <h1><?php echo Yii::t('examination','New Exam');?></h1>
...
<div  style="position:relative">
    <div class="edit_bttns" style="width:250px; top:-110px; right:-15px;">
    <ul>
    <li>
<?php echo CHtml::link(Yii::t('examination','<span>Create Exam</span>'), array('#'),array('id'=>'add_exam-groups','class'=>'addbttn')) ?>
 </li>
 <li>
<?php echo CHtml::link(Yii::t('examination','<span>Grading Levels</span>'), array('/examination/gradingLevels','id'=>$_REQUEST['id']),array('class'=>'addbttn last')) ?>
 </li>
    </ul>
    <div class="clear"></div>
    </div>
