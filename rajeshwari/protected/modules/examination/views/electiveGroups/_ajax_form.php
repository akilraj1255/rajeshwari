...
<div id="elective-groups_form_con" class="client-val-form">
    <?php if ($model->isNewRecord) : ?>    <h3 id="create_header"><?php echo Yii::t('examination','Create New Elective Groups')?></h3>
    <?php  elseif (!$model->isNewRecord):  ?>    <h3 id="update_header"><?php echo Yii::t('examination','Update Elective Groups');?><?php  echo
        $model->id;  ?>  </h3>
    <?php   endif;  ?>
    <?php      $val_error_msg = Yii::t('examination','Error.Elective Groups was not saved.');
    $val_success_message = ($model->isNewRecord) ?
            Yii::t('examination','Elective Groups was created successfuly.') :
            Yii::t('examination','Elective Groups  was updated successfuly.');
  ?>
