...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
   ...
   <?php $this->renderPartial('/default/left_side');?>
    ...
    <h1><?php echo Yii::t('examination','Set Grading Levels');?></h1>
   <div style="position:relative">
    <div class="edit_bttns" style="width:250px; top:-40px; right:-125px;">
    <ul>

    <li>
    <?php echo CHtml::link('<span>'.Yii::t('examination','Assessments').'</span>', array('/examination/exam','id'=>$_REQUEST['id']),array('class'=>'addbttn last'));?>
    </li>
    </ul>
    <div class="clear"></div>
    </div>
...
<div class="right" align="left">
            ...
            <?php echo CHtml::link(Yii::t('examination','Set Default Grading Levels'), array('gradingLevels/default','id'=>$_REQUEST['id']),array('class'=>'cbut','confirm'=>'Are You Sure? All custom settings will be deleted.'));?>
