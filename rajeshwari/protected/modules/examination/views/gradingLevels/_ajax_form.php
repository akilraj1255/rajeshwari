...
<div id="grading-levels_form_con" class="client-val-form">
    <?php if ($model->isNewRecord) : ?>    <h3 id="create_header"><?php echo Yii::t('examination','Create New Grading Levels');?></h3>
    <?php  elseif (!$model->isNewRecord):  ?>    <h3 id="update_header"><?php echo Yii::t('examination','Update Grading Levels');?> <?php  echo
        $model->id;  ?>  </h3>
    <?php   endif;  ?>
  <link rel="stylesheet" type="text/css" href="<?php echo Yii::app()->request->baseUrl; ?>/css/ui-style.css" />
    <?php      $val_error_msg = Yii::t('examination','Error.GradingLevels was not saved.');
    $val_success_message = ($model->isNewRecord) ?
            Yii::t('examination','Grading Levels was created successfuly.') :
            Yii::t('examination','Grading Levels  was updated successfuly.');
  ?>
...
<?php   $formId='grading-levels-form';
   ...
   ($model->isNewRecord)?CController::createUrl('gradingLevels/ajax_create')
    ...
    <div class="row">
        ...
        <span style="margin-top:0px; position: relative; right:-3px; top:-23px;"  id="success-GradingLevels_name"
        ...
        <span style="margin-top:0px; position: relative; right:-3px; top:-23px;"  id="success-GradingLevels_min_score"
              class="hid input-notification-success  success png_bg right"></span>
        <div>
            <small></small>
        </div>
