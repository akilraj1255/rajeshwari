...
<?php $this->renderPartial('//assesments/left_side');?>
    ...
    <div align="right" style="width:60%"><?php echo CHtml::link(Yii::t('examination','New'), array('create', 'id'=>$_REQUEST['id']),array('class'=>'cbut')); ?></div>
    <br />
    <div class="tableinnerlist">
    <table width="60%" cellpadding="0" cellspacing="0" >
    <tr>
     <th><?php echo Yii::t('examination','Exam Name');?></th>
     <th><?php echo Yii::t('examination','Action');?></th>
    </tr> 
