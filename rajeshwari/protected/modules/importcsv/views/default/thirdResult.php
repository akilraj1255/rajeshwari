...
if($error==1) {
    ...
    echo("<span class='importCsvError'>".Yii::t('importcsvModule.importcsv', 'Error').": ".Yii::t('importcsvModule.importcsv', 'Select all mandatory fields')."</span>");
}
elseif($error==2) {
...
elseif($error==0) {
    ...
    //echo "<span class='importCsvNoError'>".Yii::t('importcsvModule.importcsv', 'Import was carried out')."<br/><br/>".Yii::t('importcsvModule.importcsv', 'Errors in rows').": ".$strings."</span>";
	
	echo "<span class='importCsvNoError'>".Yii::t('importcsvModule.importcsv', 'Import was carried out , '.$total_rows_inserted.' of '.$total_rows.' rows inserted')."</span>";
