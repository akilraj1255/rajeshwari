...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <?php echo Yii::t('downloads','View Uploaded File'); ?>
  ...
  <tr>
    ...
    <th><?php echo Yii::t('downloads','Placeholder'); ?></th>
    <th><?php echo Yii::t('downloads','Course'); ?></th>
    <th><?php echo Yii::t('downloads','Batch'); ?></th>
